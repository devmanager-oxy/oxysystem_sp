...
function cmdChangeList(){
	document.frmcoa.action="bsstandard_v01.jsp";
                ...
                <td width="100%" valign="top"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
					  ...
					  <%
					  String navigator = "<font class=\"lvl1\">Financial Report</font><font class=\"tit1\">&nbsp;&raquo;&nbsp;<span class=\"lvl2\">Neraca Akhir</span></font>";
					  %>
                            ...
                            <tr align="left" valign="top"> 
                              <td height="8"  colspan="3" class="container"> 
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
								  ...
								  <tr align="left"> 
                                    <td height="20" valign="middle" align="center" colspan="3"><span class="level1"><font size="+1"><b><font size="+1">NERACA 
                                      AKHIR </font></b></font></span></td>
                                  </tr>                          
								  <%
								  ...
								  %>        
								  <tr align="left"> 
                                    <td height="20" valign="middle" align="center" colspan="3"><span class="level1"><b><font size="2"><%=openPeriod.toUpperCase()%></font></b></span></td>
                                  </tr>         
							...
							for(int i=0; i<listCoa.size(); i++)
							{
								...
								if (coa.getAccountGroup().equals(I_Project.ACC_GROUP_LIQUID_ASSET))
								{
									...
									if (coa.getStatus().equals("HEADER")){
										...
										amountPrevYear = DbCoa.getCoaBalanceByHeaderPrevYear(coa.getOID(),"DC");
									}
									...
									for(int i=0; i<listCoa.size(); i++)
									{
										...
										if (coa.getAccountGroup().equals(I_Project.ACC_GROUP_EQUITY))
										{
											...
											if(coa.getCode().equals(DbSystemProperty.getValueByName("ID_HEADER_CURRENT_EARNING")))
											{
												...
												//out.println("<br><br>periode : "+periode.getOID()+", coa.getOID() : "+coa.getOID()+", DbCoaOpeningBalance.getOpeningBalance(periode, coa.getOID() "+ DbCoaOpeningBalance.getOpeningBalance(periode, coa.getOID())+"<br>");
											...
											//tampil terfilter yang terisi saja
											
											if (valShowList==1){
												
												/******************************************************************
												ID_RETAINED_EARNING => header laba tahun lalu, ID_HEADER_CURRENT_EARNING => header laba tahun berjalan
												D_RETAINED_EARNINGS => kode akun postable laba tahun berjalan 1, ID_RETAINED_EARNINGS_1 => kode akun postable laba tahun berjalan 2 
												*******************************************************************/
