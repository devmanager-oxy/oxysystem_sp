                      ...
                      <td><!-- #BeginEditable "content" --> 
                                  ...
                                  <tr align="left" valign="top"> 
                                    <td height="22" valign="middle" colspan="3" class="page"> 
                                      <table width="100%" border="0" cellpadding="1" height="20" cellspacing="1">
                                        <tr> 
                                          <td rowspan="2" class="tablehdr" height="45" width="31%"> 
                                            <div align="center"><b><font color="#FFFFFF">DESCRIPTION</font></b></div>
                                          </td>
                                          <td class="tablehdr" height="45" rowspan="2" width="9%">THN<br>
                                            <%=(JSPFormater.formatDate(periode.getStartDate(), "yyyy")).toUpperCase()%></td>
                                        ...
                                        <tr> 
                                          <td class="tablehdr" height="22" width="8%">S/D 
                                            BLN INI</td>
                                          <td class="tablehdr" height="22" width="9%">BLN 
                                            INI </td>
                                          <td width="9%" class="tablehdr" height="22">S/D 
                                            BLN LALU</td>
                                          ...
                                          <td width="6%" class="tablehdr" height="22">S/D 
                                            BLN INI</td>
                                          <td width="8%" class="tablehdr" height="22">BLN 
                                            INI </td>
                                        </tr>
									...
									if(pnlType==1){	
                                        ...
                                        <tr> 
                                          ...
                                          <td width="8%" class="tablecell" nowrap></td>
                                          <td width="9%" class="tablecell" nowrap></td>
                                          <td width="9%" class="tablecell" nowrap></td>
										...
										if(listCoa!=null && listCoa.size()>0)
										{
											...
											for(int i=0; i<listCoa.size(); i++)
											{
												...
												{
													double budget = DbCoaBudget.getBudgetRecursif(coa, yearx);
													double budgetMth = budget/12;
													double budgetSD = budgetMth * (startDate.getMonth() + 1);								
													
													//out.println("budget : "+budget);
													
													displayStrBudgetYr = (budget==0) ? "" : JSPFormater.formatNumber(budget, "#,###.##");
													displayStrBudget = (budgetMth==0) ? "" : JSPFormater.formatNumber(budgetMth, "#,###.##");
                                        ...
                                        <tr> 
                                          ...
                                          <td width="8%" class="<%=cssString%>" nowrap> 
                                            <table width="100%" border="0" cellpadding="0" cellspacing="1">
                                              <tr> 
                                                <td width="7%"></td>
                                                <td width="88%" class="<%=cssString%>"> 
                                          ...
                                          <td width="8%" class="<%=cssString%>" nowrap>&nbsp;</td>
                                        </tr>
                                        <%				}
						...
						%>
                                        <tr> 
                                          ...
                                          <td width="8%" class="tablecell2" align="right" nowrap>&nbsp;</td>
                                        ...
                                        <tr> 
                                          ...
                                          <td width="8%" class="tablecell1" nowrap>&nbsp;</td>
