                ...
                <td width="100%" valign="top"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr align="left" valign="top"> 
                              <td height="8"  colspan="3" class="container"> 
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  ...
                                  <tr align="left" valign="top"> 
                                    <td height="20" valign="middle" align="center" colspan="3"><span class="level1"><font size="+1"><b>PROFIT 
                                      & LOSS STATEMENT</b></font></span></td>
                                  </tr>
                                  <%
								  ...
								  %>
                                  <tr align="left" valign="top"> 
                                    <td height="20" valign="middle" align="center" colspan="3"><span class="level1"><b>PERIOD 
                                      <%=openPeriod.toUpperCase()%></b></span></td>
                                  </tr>
                                  <tr align="left" valign="top">
                                    ...
                                    <td height="22" valign="middle" colspan="3" class="page"> 
                                      <table width="100%" border="0" cellpadding="1" height="20" cellspacing="1">
                                        <tr> 
                                          ...
                                          <td width="120" class="tablehdr" height="22" nowrap>P 
                                            &amp; L Prev. Period</td>
					...
					%>
										...
										%>
                                        <tr> 
                                          <td class="tablecell2"><span class="level2"><b>Net 
                                            Income</b></span></td>
                                          <%
