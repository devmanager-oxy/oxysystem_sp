                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr> 
                      <td><!-- #BeginEditable "content" --> 
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  ...
                                  <tr align="left" valign="top"> 
									...
									if(pnlType==1){	
										...
										%>
                                        <tr> 
                                          <td width="56%" class="tablecell"><b><%="PENDAPATAN"%><%//=I_Project.ACC_GROUP_REVENUE%></b></td>
						...
						%>
                                        <tr> 
                                          <td width="56%" class="tablecell2"><span class="level2"><b><%=xtotal%></b></span></td>
										...
										%>
                                        <tr> 
                                          <td width="56%" class="tablecell"><b><%="HARGA POKOK PENJUALAN"%><%//=I_Project.ACC_GROUP_COST_OF_SALES%></b></td>
					...
					%>
										...
										%>
                                        <tr> 
                                          <td width="56%" class="tablecell"><b><%="BIAYA"%><%//=I_Project.ACC_GROUP_EXPENSE%></b></td>
                                          <td width="16%" class="tablecell" nowrap> 
                                            <div align="right"></div>
                                          </td>
                                          <td width="14%" class="tablecell" nowrap> 
					...
					%>
										...
										%>
                                        <tr> 
                                          <td width="56%" class="tablecell"><b><%="PENDAPATAN LAIN-LAIN"%><%//=I_Project.ACC_GROUP_OTHER_REVENUE%></b></td>
                                          <td width="16%" class="tablecell" nowrap> 
                                            <div align="right"></div>
                                          </td>
                                          <td width="14%" class="tablecell" nowrap> 
					...
					%>
										...
										%>
                                        <tr> 
                                          <td width="56%" class="tablecell"><b><%="BIAYA LAIN-LAIN"%><%//=I_Project.ACC_GROUP_OTHER_EXPENSE%></b></td>
                                          <td width="16%" class="tablecell" nowrap> 
                                            <div align="right"></div>
                                          </td>
                                          <td width="14%" class="tablecell" nowrap> 
