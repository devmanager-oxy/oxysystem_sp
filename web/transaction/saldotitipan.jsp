...
String str = DbSystemProperty.getValueByName("COA_TITIPAN");
...
Vector vnds = DbVendor.list(0,0, "type="+DbVendor.VENDOR_TYPE_PENITIP,""); 
...
rptKonstan.setName("SALDO TITIPAN");
...
function cmdDetail(oid){
	...
	document.form1.action="saldotitipanaudit.jsp";
	document.form1.submit();
}

function cmdChange(){
	document.form1.action="saldotitipan.jsp";
	document.form1.submit();
}
                ...
                <td width="100%" valign="top"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
					  ...
					  <%
					  String navigator = "<font class=\"lvl1\">Titipan</font><font class=\"tit1\">&nbsp;&raquo;&nbsp;<span class=\"lvl2\">Saldo Titipan</span></font>";
					  %>
                                  ...
                                  <tr> 
                                    <td colspan="2"> 
                                      <table width="65%" border="0" cellspacing="1" cellpadding="1">
                                        <tr> 
                                          <td width="58%" class="tablehdr">Uraian</td>
                                          <td width="31%" class="tablehdr">Saldo 
                                            Titipan</td>
                                          <td width="11%" class="tablehdr">&nbsp;</td>
                                        </tr>
                                        <%
										 double tTotal = 0;
										 if(temp!=null && temp.size()>0){
											for(int i=0; i<temp.size(); i++){
												...
												detail.setUraian(""+v.getCode()+" - "+v.getName());
												detail.setSaldoTitipan(cr.getDebet());
										...
										%>
                                        <tr> 
                                          <td width="58%" class="tablecell" nowrap><%=v.getCode()+" - "+v.getName()%></td>
                                        ...
                                        <%}else{%>
                                        <tr> 
                                          <td width="58%" class="tablecell1" nowrap><%=v.getCode()+" - "+v.getName()%></td>
                                          <td width="31%" class="tablecell1"> 
                                            <div align="right"><%=JSPFormater.formatNumber(cr.getDebet(), "#,###.##")%></div>
                                          </td>
