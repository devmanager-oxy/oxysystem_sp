...
Vector vnds = DbVendor.list(0,0, "type="+DbVendor.VENDOR_TYPE_PENITIP,"code,name"); 
                ...
                <td width="100%" valign="top"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
					  ...
					  <%
					  String navigator = "<font class=\"lvl1\">Deposit/Titipan</font><font class=\"tit1\">&nbsp;&raquo;&nbsp;<span class=\"lvl2\">Transaksi Titipan</span></font>";
					  %>
                            ...
                            <tr> 
                              <td class="container">
                                <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                  ...
                                  <tr> 
                                    <td width="9%">&nbsp;Penitip</td>
                                    <td width="91%"><b>:&nbsp; <%=vendor.getName()%></b></td>
                                  </tr>
                                  <tr> 
                                    <td width="9%">&nbsp;</td>
                                    <td width="91%">&nbsp;</td>
                                    ...
                                    <td colspan="2"> 
                                      <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                        ...
                                        <tr> 
                                          ...
                                          <td width="19%" class="tablecell"><%=((gl.getMemo()!=null && gl.getMemo().length()>0) ? gl.getMemo()+" - " : "") + gd.getMemo()%></td>
                                        ...
                                        <tr> 
                                          ...
                                          <td width="19%" class="tablecell1"><%=((gl.getMemo()!=null && gl.getMemo().length()>0) ? gl.getMemo()+" - " : "") + gd.getMemo()%></td>
