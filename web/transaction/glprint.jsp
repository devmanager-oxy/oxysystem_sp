                                                      ...
                                                      <td> 
                                                        <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                                          <tr> 
                                                            ...
                                                            <td rowspan="2" class="tablehdr" width="24%">Department</td>
                                                            <td colspan="2" class="tablehdr">Currency</td>
                                                            <td rowspan="2" class="tablehdr" width="5%">Booked 
                                                              Rate</td>
                                                            <td rowspan="2" class="tablehdr" width="8%">Debet 
                                                              <%=baseCurrency.getCurrencyCode()%></td>
                                                            <td rowspan="2" class="tablehdr" width="8%">Credit 
                                                              <%=baseCurrency.getCurrencyCode()%> </td>
                                                            <td rowspan="2" class="tablehdr" width="13%">Description</td>
                                                          </tr>
                                                          <tr> 
                                                            <td width="4%" class="tablehdr">Code</td>
                                                            <td width="8%" class="tablehdr"> 
                                                              Amount</td>
                                                          </tr>
                                                          <%
														  		if(listGlDetail!=null && listGlDetail.size()>0)
