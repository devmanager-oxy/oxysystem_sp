...
String str = DbSystemProperty.getValueByName("COA_DIBAYAR_DIMUKA");
...
Vector vnds = DbVendor.list(0,0, "type="+DbVendor.VENDOR_TYPE_DP,""); 
...
rptKonstan.setName("SALDO DEPOSIT");
...
function cmdDetail(oid){
	...
	document.form1.action="saldodepositaudit.jsp";
	document.form1.submit();
}

function cmdChange(){
	document.form1.action="saldodp.jsp";
	document.form1.submit();
}

function cmdPrintDeposit(){	 
	window.open("<%=printroot%>.report.RptSaldoDpXLS?idx=<%=System.currentTimeMillis()%>");
}
                ...
                <td width="100%" valign="top"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
					  ...
					  <%
					  String navigator = "<font class=\"lvl1\">Deposit/DP</font><font class=\"tit1\">&nbsp;&raquo;&nbsp;<span class=\"lvl2\">Saldo Deposit</span></font>";
					  %>
                                    ...
                                    <td colspan="2"> 
                                      <table width="65%" border="0" cellspacing="1" cellpadding="1">
                                        <tr> 
                                          ...
                                          <td width="25%" class="tablehdr">Saldo 
                                            DP</td>
										...
										%>
                                        <tr> 
                                          <td width="64%" class="tablecell"><%=v.getCode()+" - "+v.getName()%></td>
                                        ...
                                        <%}else{%>
                                        <tr> 
                                          <td width="64%" class="tablecell1"><%=v.getCode()+" - "+v.getName()%></td>
