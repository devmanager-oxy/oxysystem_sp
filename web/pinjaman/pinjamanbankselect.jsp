          ...
          <td valign="top"> 
            <table width="100%" border="0" cellpadding="0" cellspacing="0" height="100%">
              ...
              <tr> 
               ...
               <%
String navigator = "<font class=\"lvl1\">Pinjaman Anggota Ke Bank</font><font class=\"tit1\">&nbsp;&raquo;&nbsp;<span class=\"lvl2\">Pinjaman Bank Baru</span></font>";
               %>
                              ...
                              <td class="container">
                                <table width="24%" border="0" cellspacing="1" cellpadding="1">
                                  ...
                                  <tr> 
                                    <td width="16%">&nbsp;</td>
                                    <td width="27%"> 
                                      <div align="center"><a href="pinjamanbank.jsp?menu_idx=<%=menuIdx%>"><img src="../images/revised.gif" width="50" height="41" border="0"></a></div>
                                    </td>
                                    <td width="21%"> 
                                      <div align="center"></div>
                                    </td>
                                    <td width="36%"> 
                                      <div align="center"><a href="pinjamanbankanuitas.jsp?menu_idx=<%=menuIdx%>"><img src="../images/approve.gif" width="50" height="43" border="0"></a></div>
                                    </td>
                                  </tr>
                                  <tr> 
                                    <td width="16%">&nbsp;</td>
                                    <td width="27%"> 
                                      <div align="center"><a href="pinjamanbank.jsp?menu_idx=<%=menuIdx%>">Bunga 
                                        Tetap</a></div>
                                    </td>
                                    <td width="21%"> 
                                      <div align="center"></div>
                                    ...
                                    <td width="36%"> 
                                      <div align="center"><a href="pinjamanbankanuitas.jsp?menu_idx=<%=menuIdx%>">Bunga 
                                        Anuitas</a></div>
                                    </td>
                                  </tr>
                                  <tr> 
