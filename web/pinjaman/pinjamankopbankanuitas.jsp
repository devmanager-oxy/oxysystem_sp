    ...
    <head>
        ...
        <script language="JavaScript">
            ...
            function cmdPrintXLS(){	 
                window.open("<%=printrootsp%>.report.RptPinjamanKoprasiXLS?idx=<%=System.currentTimeMillis()%>");
            }

            function cmdPrintPdf(){
                window.open("<%=printrootsp%>.report.RptPinjamanKoprasiPdf?idx=<%=System.currentTimeMillis()%>","",'scrollbars=yes,status=yes,width=750,height=600,resizable=yes');
            }
