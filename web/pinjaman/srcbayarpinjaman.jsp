...
<%
            boolean priv = QrUserSession.isHavePriviledge(appSessUser.getUserOID(), AppMenu.MENU1_SIPADU_PINJAMAN, AppMenu.M2_SIPADU_PINJAMAN_ANGG_KOP_ANGSURAN);
            boolean privView = appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.MENU1_SIPADU_PINJAMAN, AppMenu.M2_SIPADU_PINJAMAN_ANGG_KOP_ANGSURAN, AppMenu.PRIV_VIEW);
            boolean privUpdate = appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.MENU1_SIPADU_PINJAMAN, AppMenu.M2_SIPADU_PINJAMAN_ANGG_KOP_ANGSURAN, AppMenu.PRIV_UPDATE);
            boolean privAdd = appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.MENU1_SIPADU_PINJAMAN, AppMenu.M2_SIPADU_PINJAMAN_ANGG_KOP_ANGSURAN, AppMenu.PRIV_ADD);
            boolean privDelete = appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.MENU1_SIPADU_PINJAMAN, AppMenu.M2_SIPADU_PINJAMAN_ANGG_KOP_ANGSURAN, AppMenu.PRIV_DELETE);
%>
<%
//jsp content
                  ...
                  <%@ include file="../main/menusp.jsp"%>
                                   <%@ include file="../calendar/calendarframe.jsp"%>
                                        ...
                                        <td width="100%" valign="top"> 
                                           ...
                                           <%                                           
            String navigator = "<font class=\"lvl1\">Pinjaman Anggota Ke Koperasi</font><font class=\"tit1\">&nbsp;&raquo;&nbsp;<span class=\"lvl2\">Angsuran</span></font>";
                                           %>
