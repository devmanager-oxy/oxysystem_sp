                            ...
                            <tr align="left" valign="top"> 
                              <td height="8" valign="middle" colspan="3" class="container"> 
                                <table width="100%" border="0" cellspacing="1" cellpadding="0">
										...
										if(listBank!=null && listBank.size()>0){
											for(int i=0; i<listBank.size(); i++){
												...
												if(bank.getOID()==pinjaman.getBankId()){
													rptKonstan.setBank(bank.getName());
												}
										%>
                                  ...
                                  <tr align="left"> 
                                    <td height="22" valign="middle" width="11%" bgcolor="#EEEEEE"> 
                                      <div align="center"><b>Detail Jurnal </b></div>
                                    </td>
                                    <td height="22" width="24%" valign="top">&nbsp;</td>
                                    <td height="22" width="14%" valign="top">&nbsp;</td>
                                    <td height="22" width="51%" valign="top">&nbsp;</td>
                                  </tr>
                                  <tr align="left"> 
                                  ...
                                  <tr align="left" > 
                                    <td colspan="4" valign="top"> 
                                      <div align="left"> 
                                        <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                          <tr> 
                                            <td class="tablehdr" width="7%" nowrap>Angsuran 
                                            </td>
                                            <td class="tablehdr" width="12%" nowrap>Pokok 
                                              Angsuran</td>
                                            <td class="tablehdr" width="11%" nowrap>Bunga 
                                              Koperasi </td>
                                            <td class="tablehdr" width="10%" nowrap>Saldo</td>
                                            <td class="tablehdr" width="13%" nowrap>Angsuran 
                                              Koperasi</td>
                                            <td class="tablehdr" width="9%" nowrap>Jatuh 
                                              Tempo</td>
                                            <td class="tablehdr" width="9%" nowrap>Status</td>
                                            <td class="tablehdr" width="10%" nowrap>Tanggal 
                                              Angsuran</td>
                                            <td class="tablehdr" width="10%">Angsuran</td>
                                            <td class="tablehdr" width="9%">Pelunasan</td>
                                          </tr>
                                          <tr> 
                                            <td class="tablecell" width="7%">&nbsp;</td>
										  ...
										  for(int i=0; i<pds.size(); i++){
												...
												RptAnggotaPinjamBankL detail = new RptAnggotaPinjamBankL();
												...
												detail.setKwjbAngsuran(pd.getAmount()+pd.getBunga());
                                          ...
                                          <tr> 
                                            ...
                                            <td class="tablecell1" colspan="2" height="25"> 
                                              <div align="right"><b>Total Pinjaman 
                                                : </b></div>
                                            </td>
                                            <td class="tablecell1" colspan="2" height="25"> 
                                          ...
                                          <tr> 
                                            ...
                                            <td class="tablecell1" colspan="2" height="24"> 
                                              <div align="right"><b>Total Angsuran 
                                                : </b></div>
                                            </td>
                                            <td class="tablecell1" colspan="2" height="24"> 
                                              <div align="right"> <b> 
                                          ...
                                          <tr> 
                                            ...
                                            <td class="tablecell1" colspan="2" height="21"> 
                                              <div align="right"><b>Sisa : </b></div>
                                            </td>
                                            <td class="tablecell1" colspan="2" height="21"> 
