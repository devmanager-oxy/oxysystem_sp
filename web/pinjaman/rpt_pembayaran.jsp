                                  ...
                                  <tr> 
                                    <td> 
                                      <table width="30%" border="0" cellspacing="1" cellpadding="1">
                                        <tr> 
                                          <%if(type==1){%>
                                          <td width="9%"><a href="javascript:cmdPrintDetailXLS()"><img src="../images/printxls.gif" border="0"></a></td>
                                          <%}else{%>
                                          <td width="9%"><a href="javascript:cmdPrintSumrayXLS()"><img src="../images/printxls.gif" border="0"></a></td>
                                          <%}%>
                                        </tr>
                                      </table>
                                    </td>
