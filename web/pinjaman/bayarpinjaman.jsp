...
<%
            boolean priv = QrUserSession.isHavePriviledge(appSessUser.getUserOID(), AppMenu.MENU1_SIPADU_PINJAMAN, AppMenu.M2_SIPADU_BAYAR_PINJAMAN_ANGG);
            boolean privView = appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.MENU1_SIPADU_PINJAMAN, AppMenu.M2_SIPADU_BAYAR_PINJAMAN_ANGG, AppMenu.PRIV_VIEW);
            boolean privUpdate = appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.MENU1_SIPADU_PINJAMAN, AppMenu.M2_SIPADU_BAYAR_PINJAMAN_ANGG, AppMenu.PRIV_UPDATE);
            boolean privAdd = appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.MENU1_SIPADU_PINJAMAN, AppMenu.M2_SIPADU_BAYAR_PINJAMAN_ANGG, AppMenu.PRIV_ADD);
            boolean privDelete = appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.MENU1_SIPADU_PINJAMAN, AppMenu.M2_SIPADU_BAYAR_PINJAMAN_ANGG, AppMenu.PRIV_DELETE);
%>
<!-- Jsp Block -->
<%
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" height="100%">
            ...
            <%@ include file="../main/hmenusp.jsp"%>
                  ...
                  <%@ include file="../calendar/calendarframe.jsp"%>
                                        ...
                                        <td width="100%" valign="top"> 
                                           ...
                                           <%
            String navigator = "<font class=\"lvl1\">Pinjaman</font><font class=\"tit1\">&nbsp;&raquo;&nbsp;<font class=\"lvl1\">Pinjaman Anggota</font><font class=\"tit1\">&nbsp;&raquo;&nbsp;<span class=\"lvl2\">Bayar Pinjaman</span></font>";
                                           %>
            ...
            if (bayarPinjaman.getOID() != 0) {
                num = bayarPinjaman.getNoTransaksi();
                                                                            ...
                                                                            <tr align="left"> 
                                                                                ...
                                                                                <td  width="20%"> 
                                                                                    <input type="text" name="<%=JspBayarPinjaman.colNames[JspBayarPinjaman.JSP_CICILAN_KE]%>" value="<%=bayarPinjaman.getCicilanKe()%>" class="readOnly" readonly style="text-align:right">
                                                                            ...
                                                                            <tr align="left"> 
                                                                                ...
                                                                                <td  width="13%" bgcolor="#F5F5F5"> 
                                                                                    <div align="center"><b>Jenis Anggusuran</b></div>
                                                                                </td>
                                                                                <td  width="56%">                                                                                    
                                                                                    <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                                                                        <tr>
            ...
            if (bayarPinjaman.getOID() == 0) {
                ...
                out.println(cx.getCode() + " - " + cx.getName());
                                                                                        ...
                                                                                        <tr bgcolor="#E1E1E1"> 
                                                                                            <td width="30%">Pendapatan Denda Diterima 
                                                                                            Pada </td>
                                                                                            <td width="34%">
                                                                                                <%
            if (bayarPinjaman.getOID() == 0) {
            ...
            if (bayarPinjaman.getOID() == 0) {
                ...
                out.println(cx.getCode() + " - " + cx.getName());
                                                                            ...
                                                                            <tr> 
                                                                                ...
                                                                                <td width="20%"> 
                                                                                    <input type="text" name="total" value="" class="readOnly" style="text-align:right" onBlur="javascript:checkNumber1(this)" readonly>
                                                                                </td>
                                                                            </tr>
                                                                            <tr> 
                                                                                <td width="11%">&nbsp;</td>
