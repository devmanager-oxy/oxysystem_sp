...
function cmdActivity(oid){
	document.frmbanknonpopaymentdetail.hidden_bankarchive.value=oid;
	document.frmbanknonpopaymentdetail.hidden_banknonpo_payment_id.value=oid;
	//document.frmbanknonpopaymentdetail.action="banknonpoactivityprint.jsp";
	<%if(banknonpoPayment.getActivityStatus().equals(I_Project.NA_NOT_POSTED_STATUS)){%>
                                          ...
                                          <td colspan="4"> 
                                            <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                              ...
                                              <tr> 
                                                ...
                                                <td width="42%"> 
                                                  <%
									  int counter = DbBanknonpoPayment.getNextCounter(sysCompany.getOID());
									  String strNumber = DbBanknonpoPayment.getNextNumber(counter, sysCompany.getOID());
                                                      ...
                                                      <td><%if(applyActivity){%> 
                                                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                          <tr > 
                                                            ...
                                                            <td class="<%if(banknonpoPayment.getType()==I_Project.TYPE_INT_EMPLOYEE_ADVANCE){%>tabheader<%}else{%>tabin<%}%>"><%if(banknonpoPayment.getType()==I_Project.TYPE_INT_EMPLOYEE_ADVANCE){}else{%><a href="javascript:cmdActivity('<%=oidBanknonpoPayment%>')" class="tablink">Activity</a><%}%></td>
                                                            <td class="tabheader"><img src="<%=approot%>/images/spacer.gif" width="3" height="10"></td>
                                                            <td class="tabheader"><img src="<%=approot%>/images/spacer.gif" width="3" height="10"></td>
