...
<%if(iJSPCommand==JSPCommand.SAVE && isOK){%>
	window.location="banknonpoactivity.jsp?hidden_banknonpo_payment_id=<%=oidBanknonpoPayment %>&command=<%=JSPCommand.ADD%>&select_idx=-1";
<%}%>
...
function cmdFixing(){	
	...
	document.frmbanknonpodetail.action="banknonpoactivitypredefined.jsp";
...
function cmdDelPict(oidActivityDetail){
	...
	document.frmimage.action="banknonpoactivitypredefined.jsp";
                ...
                <td width="100%" valign="top"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td class="title">
					  <%
					  String navigator = "<font class=\"lvl1\">Bank&nbsp;&raquo;&nbsp;Non PO&nbsp;&raquo;&nbsp;Payment</font><font class=\"tit1\">&nbsp;&raquo;&nbsp;<span class=\"lvl2\">Predefined Activity</span></font>";
					  %>
