...
<%!
...

	{
        ...
        cmdist.addHeader("Pay. Status","10%");
...
//out.println("unitUsahaId : "+unitUsahaId);

long srcVendorId = JSPRequestValue.requestLong(request, "src_vendor_id");
String srcStatus = I_Project.DOC_STATUS_CHECKED;//JSPRequestValue.requestString(request, "src_status");
...
int vectSize = DbReceive.getCount(srcStatus, srcVendorId, 
        srcIgnore, srcStartDate, srcEndDate, unitUsahaId);
...
listReceive = DbReceive.list(start,recordToGet, srcStatus, srcVendorId, 
        srcIgnore, srcStartDate, srcEndDate, unitUsahaId);
