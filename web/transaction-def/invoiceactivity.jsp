...
function cmdResetIsDirect(){
	...
	document.frminvoiceitem.action="invoiceactivity.jsp";
...
function cmdInvoice(oid){
	...
	document.frminvoiceitem.prev_command.value="<%=prevJSPCommand%>";
	document.frminvoiceitem.action="invoiceprint.jsp";
	document.frminvoiceitem.submit();
	<%}else{%>
...
function cmdPredefined(oid){
		...
		document.frminvoiceitem.command.value="<%=JSPCommand.EDIT%>";
		document.frminvoiceitem.prev_command.value="<%=prevJSPCommand%>";
		document.frminvoiceitem.action="invoiceactivitypredefined.jsp";
		document.frminvoiceitem.submit();
...
function cmdDelPict(oidTransactionActivityDetail){
	...
	document.frmimage.action="invoiceactivity.jsp";
                ...
                <td width="100%" valign="top"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
					  ...
					  <%
					  String navigator = "<font class=\"lvl1\">Account Payable</font><font class=\"tit1\">&nbsp;&raquo;&nbsp;<span class=\"lvl2\">Invoice Activity</span></font>";
					  %>
