...
function cmdChange(){
	document.form1.action="saldodepositmapping.jsp";
                ...
                <td width="100%" valign="top"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
					  ...
					  <%
					  String navigator = "<font class=\"lvl1\">Deposit/DP</font><font class=\"tit1\">&nbsp;&raquo;&nbsp;<span class=\"lvl2\">Transaksi</span></font>";
					  %>
