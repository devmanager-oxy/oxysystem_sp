...
CmdCompany_2 ctrlCompany = new CmdCompany_2(request);
...
/* end switch*/
JspCompany_2 jspCompany = ctrlCompany.getForm();
...
if(iJSPCommand==JSPCommand.SUBMIT && iErrCode==0){
	...
	companySess.setGeneralLedgerCode(company.getGeneralLedgerCode());
	companySess.setInvoiceCode(company.getInvoiceCode());
	...
	try{
		oid = DbCompany.insertExc(companySess);
	}
	catch(Exception e){
	}
}
...
<%if(iJSPCommand==JSPCommand.SUBMIT && iErrCode==0 && oid!=0){%>
	alert('Your configuration data has been saved successfully,\nclick OK to continue.');
	window.location="<%=approot%>/home.jsp";
<%}%>
...
function cmdSave(){
	if(confirm('Are you sure to save these configuration data ? \nthis action can not be undone, please contact your system administrator if you need to update')){
		document.frmcompany.command.value="<%=JSPCommand.SUBMIT%>";
		document.frmcompany.prev_command.value="<%=prevJSPCommand%>";
		document.frmcompany.action="company_3.jsp";
		document.frmcompany.submit();
	}
}
...
<body onLoad="MM_preloadImages('<%=approot%>/images/home2.gif','<%=approot%>/images/logout2.gif','../images/back2.gif','../images/finish2.gif')">
                ...
                <td width="100%" valign="top"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
					  ...
					  <%
					  String navigator = "<font class=\"lvl1\">Company Profile</font><font class=\"tit1\">&nbsp;&raquo;&nbsp;<span class=\"lvl2\">Step 5 of 5</span></font>";
					  %>
                                ...
                                <table width="100%" border="0" cellspacing="1" cellpadding="0">
                                  ...
                                  <tr align="left"> 
                                    ...
                                    <td height="21" colspan="3">&nbsp;Please specify 
                                      your prefix code for some journal type bellow. 
                                      Maximum 2 digits of character.</td>
                                  <tr align="left"> 
                                    <td height="21" valign="top" width="2%">&nbsp;</td>
                                  ...
                                  <tr align="left"> 
                                    <td height="21" valign="top" width="2%">&nbsp;</td>
                                    <td height="21" width="15%">&nbsp;Cash Receive 
                                      Code</td>
                                    <td height="21" colspan="2" width="83%" valign="top"> 
                                      <input type="text" name="<%=jspCompany.colNames[JspCompany_2.JSP_CASH_RECEIVE_CODE] %>"  value="<%= (company.getCashReceiveCode().length()<1) ? "CR" : company.getCashReceiveCode() %>" class="formElemen" size="5" maxlength="2">
                                      <%= jspCompany.getErrorMsg(JspCompany_2.JSP_CASH_RECEIVE_CODE) %> 
                                  <tr align="left"> 
                                    <td height="21" valign="top" width="2%">&nbsp;</td>
                                    <td height="21" width="15%">&nbsp;Petty Cash 
                                      Payment Code</td>
                                    <td height="21" colspan="2" width="83%" valign="top"> 
                                      <input type="text" name="<%=jspCompany.colNames[JspCompany_2.JSP_PETTYCASH_PAYMENT_CODE] %>"  value="<%= (company.getPettycashPaymentCode().length()<1) ? "PP" : company.getPettycashPaymentCode() %>" class="formElemen" size="5" maxlength="2">
                                      <%= jspCompany.getErrorMsg(JspCompany_2.JSP_PETTYCASH_PAYMENT_CODE) %> 
                                  <tr align="left"> 
                                    <td height="21" valign="top" width="2%">&nbsp;</td>
                                    <td height="21" width="15%">&nbsp;Petty Cash 
                                      Replenishment Code</td>
                                    <td height="21" colspan="2" width="83%" valign="top"> 
                                      <input type="text" name="<%=jspCompany.colNames[JspCompany_2.JSP_PETTYCASH_REPLACE_CODE] %>"  value="<%= (company.getPettycashReplaceCode().length()<1) ? "PR" : company.getPettycashReplaceCode() %>" class="formElemen" size="5" maxlength="2">
                                      <%= jspCompany.getErrorMsg(JspCompany_2.JSP_PETTYCASH_REPLACE_CODE) %> 
                                  <tr align="left"> 
                                    <td height="21" valign="top" width="2%">&nbsp;</td>
                                    <td height="21" width="15%">&nbsp;Bank Deposit 
                                      Code</td>
                                    <td height="21" colspan="2" width="83%" valign="top"> 
                                      <input type="text" name="<%=jspCompany.colNames[JspCompany_2.JSP_BANK_DEPOSIT_CODE] %>"  value="<%= (company.getBankDepositCode().length()<1) ? "BD" : company.getBankDepositCode() %>" class="formElemen" size="5" maxlength="2">
                                      <%= jspCompany.getErrorMsg(JspCompany_2.JSP_BANK_DEPOSIT_CODE) %> 
                                  <tr align="left"> 
                                    <td height="21" valign="top" width="2%">&nbsp;</td>
                                    <td height="21" width="15%">&nbsp;Bank Payment 
                                      with PO Code</td>
                                    <td height="21" colspan="2" width="83%" valign="top"> 
                                      <input type="text" name="<%=jspCompany.colNames[JspCompany_2.JSP_BANK_PAYMENT_PO_CODE] %>"  value="<%= (company.getBankPaymentPoCode().length()<1) ? "BP" :  company.getBankPaymentPoCode()%>" class="formElemen" size="5" maxlength="2">
                                      <%= jspCompany.getErrorMsg(JspCompany_2.JSP_BANK_PAYMENT_PO_CODE) %> 
                                  <tr align="left"> 
                                    <td height="21" valign="top" width="2%">&nbsp;</td>
                                    <td height="21" width="15%">&nbsp;Bank Payment 
                                      Non PO Code</td>
                                    <td height="21" colspan="2" width="83%" valign="top"> 
                                      <input type="text" name="<%=jspCompany.colNames[JspCompany_2.JSP_BANK_PAYMENT_NONPO_CODE] %>"  value="<%= (company.getBankPaymentNonpoCode().length()<1) ? "BN" : company.getBankPaymentNonpoCode() %>" class="formElemen" size="5" maxlength="2">
                                      <%= jspCompany.getErrorMsg(JspCompany_2.JSP_BANK_PAYMENT_NONPO_CODE) %> 
                                  <tr align="left"> 
                                    <td height="21" valign="top" width="2%">&nbsp;</td>
                                    <td height="21" width="15%">&nbsp;Purchase 
                                      Order Code</td>
                                    <td height="21" colspan="2" width="83%" valign="top"> 
                                      <input type="text" name="<%=jspCompany.colNames[JspCompany_2.JSP_PURCHASE_ORDER_CODE] %>"  value="<%= (company.getPurchaseOrderCode().length()<1) ? "PO" :  company.getPurchaseOrderCode()%>" class="formElemen" size="5" maxlength="2">
                                      <%= jspCompany.getErrorMsg(JspCompany_2.JSP_PURCHASE_ORDER_CODE) %> 
                                  <tr align="left"> 
                                    <td height="21" valign="top" width="2%">&nbsp;</td>
                                    <td height="21" width="15%">&nbsp;General 
                                      Ledger Code</td>
                                    <td height="21" colspan="2" width="83%" valign="top"> 
                                      <input type="text" name="<%=jspCompany.colNames[JspCompany_2.JSP_GENERAL_LEDGER_CODE] %>"  value="<%= (company.getGeneralLedgerCode().length()<1) ? "GL" :  company.getGeneralLedgerCode()%>" class="formElemen" size="5" maxlength="2">
                                      <%= jspCompany.getErrorMsg(JspCompany_2.JSP_GENERAL_LEDGER_CODE) %> 
                                  <tr align="left"> 
                                    <td height="21" valign="top" width="2%">&nbsp;</td>
                                    <td height="21" width="15%">Invoice Code</td>
                                    <td height="21" colspan="2" width="83%" valign="top"> 
                                      <input type="text" name="<%=jspCompany.colNames[JspCompany_2.JSP_INVOICE_CODE] %>"  value="<%= (company.getInvoiceCode().length()<1) ? "IN" :  company.getInvoiceCode()%>" class="formElemen" size="5" maxlength="2">
                                      <%= jspCompany.getErrorMsg(JspCompany_2.JSP_GENERAL_LEDGER_CODE) %> 
                                  <tr align="left"> 
                                    <td height="21" valign="top" width="2%">&nbsp;</td>
                                  ...
                                  <tr align="left"> 
                                    ...
                                    <td height="21" colspan="3"> 
                                      <table width="99%" border="0" cellspacing="1" cellpadding="1">
                                        <%if(iJSPCommand==JSPCommand.SUBMIT && msgString.length()>0){%>
                                        <tr> 
                                          <td colspan="4"><font color="#FF0000"> 
                                            <table border="0" cellpadding="5" cellspacing="0" class="warning" width="337">
                                              <tr> 
                                                <td width="20"><img src="<%=approot%>/images/error.gif" width="20" height="20"></td>
                                                <td width="300" nowrap><%=msgString%> </td>
                                              </tr>
                                            </table>
                                            </font></td>
                                        </tr>
                                        ...
                                        <tr> 
                                          <td colspan="4"> 
                                            <table width="99%" border="0" cellspacing="0" cellpadding="0">
                                              <tr> 
                                                <td width="6%"><a href="javascript:cmdBack()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('back','','../images/back2.gif',1)"><img src="../images/back.gif" name="back"  height="22" border="0"></a></td>
                                                <td width="14%"><a href="javascript:cmdSave()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('next','','../images/finish2.gif',1)"><img src="../images/finish.gif" name="next"  height="22" border="0"></a></td>
                                                <td width="80%">&nbsp;</td>
                                              </tr>
                                            </table>
                                          </td>
