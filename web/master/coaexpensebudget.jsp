                ...
                <td width="100%" valign="top"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
					  ...
					  <%
					  String navigator = "<font class=\"lvl1\">Master</font><font class=\"tit1\">&nbsp;&raquo;&nbsp;<span class=\"lvl2\">Activity Budget</span></font>";
					  %>
                                        ...
                                        <tr> 
                                          <td> 
                                            ...
                                            <table width="99%" border="0" cellspacing="0" cellpadding="0">
                                              ...
                                              <tr> 
                                                <td width="11%"><a href="javascript:cmdAdd()"  onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('new2111','','../images/new2.gif',1)"><img src="../images/new.gif" name="new2111" border="0" width="71" height="22"></a></td>
                                                <td width="89%">&nbsp;</td>
                                              </tr>
                                            </table>
                                            <%}%>
