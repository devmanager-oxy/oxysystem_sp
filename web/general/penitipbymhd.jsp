...
function cmdAdd(){
	...
	document.frmvendor.action="penitipbymhd.jsp";
                ...
                <td width="100%" valign="top"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
					  ...
					  <%
					  String navigator = "<font class=\"lvl1\">BYMHD</font><font class=\"tit1\">&nbsp;&raquo;&nbsp;<span class=\"lvl2\">List Uraian</span></font>";
					  %>
                    ...
                    <tr> 
                      <td><!-- #BeginEditable "content" --> 
                        <form name="frmvendor" method ="post" action="">
						  ...
						  <input type="hidden" name="<%=jspVendor.colNames[JspVendor.JSP_TYPE]%>" value="2">						  
						  <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
							...
							%>
								...
								ctrLine.setFirstImage("<img name=\"Image23x\" border=\"0\" src=\""+approot+"/images/first.gif\" alt=\"First\">");
								 ...
								 %>
                                        ...
                                        <tr align="left" valign="top"> 
                                          <td height="22" valign="middle" colspan="3">&nbsp;<a href="javascript:cmdAdd()"  onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('new2','','../images/new2.gif',1)">Uraian 
                                            Baru </a></td>
                                        </tr>
                                        <%}%>
                                      </table>
