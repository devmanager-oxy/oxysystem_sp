                                          ...
                                          <td height="8" align="left" colspan="3" class="command"> 
                                            <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                              ...
                                              <tr> 
                                                ...
                                                <td width="14%" class="tablecell1"><input type="text" name="<%=JspRekapPotonganGaji.colNames[JspRekapPotonganGaji.JSP_MANDIRI_BUNGA]+"_"+member.getOID()%>" size="10" value="<%=JSPFormater.formatNumber(rpg.getMandiriBunga(), "#,###")%>" style="text-align:right" onClick="javascript:cmdClickMe(this)" onBlur="javascript:cmdBlurMe(this, '<%=member.getOID()%>')"></td>
                                                <td width="14%" class="tablecell1"> 
                                                  <input type="text" name="<%=JspRekapPotonganGaji.colNames[JspRekapPotonganGaji.JSP_FASJABTEL]+"_"+member.getOID()%>" size="10" value="<%=JSPFormater.formatNumber(rpg.getFasjabtel(), "#,###")%>" style="text-align:right" onClick="javascript:cmdClickMe(this)" onBlur="javascript:cmdBlurMe(this, '<%=member.getOID()%>')">
                                                </td>
                                                <td width="14%" class="tablecell1"> 
                                                  ...
                                                  <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                                    <tr> 
                                                      <td width="29%" valign="top"> 
                                                        <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                                          <tr> 
                                                            <td width="5%"><%if(rekapMain.getStatus()!=DbRekapMain.DOCUMENT_STATUS_POSTED){%><a href="javascript:cmdSave()"><img src="../images/success.gif" width="20" height="20" border="0"></a><%}else{%>&nbsp;<%}%></td>
                                                            <td width="19%"><%if(rekapMain.getStatus()!=DbRekapMain.DOCUMENT_STATUS_POSTED){%><a href="javascript:cmdSave()">Save</a><%}else{%>&nbsp;<%}%></td>
                                                            <td width="6%"><%if(rekapMain.getOID()!=0 && rekapMain.getStatus()!=DbRekapMain.DOCUMENT_STATUS_POSTED){%><a href="javascript:cmdPost()"><img src="../images/yesx.gif" width="17" height="14" border="0"></a><%}else{%>&nbsp;<%}%></td>
                                                            <td width="25%"><%if(rekapMain.getOID()!=0 && rekapMain.getStatus()!=DbRekapMain.DOCUMENT_STATUS_POSTED){%><a href="javascript:cmdPost()">Posting 
                                                              Jurnal</a><%}else{%>&nbsp;<%}%></td>
                                                            <td width="16%"><%if(rekapMain.getOID()!=0){%>
