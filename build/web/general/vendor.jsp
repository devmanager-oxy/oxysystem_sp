                ...
                <td width="100%" valign="top"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
					  ...
					  <%
					  String navigator = "<font class=\"lvl1\">Master</font><font class=\"tit1\">&nbsp;&raquo;&nbsp;<span class=\"lvl2\">Vendor List</span></font>";
					  %>
                    ...
                    <tr> 
                      <td><!-- #BeginEditable "content" --> 
                        <form name="frmvendor" method ="post" action="">
						  ...
						  <input type="hidden" name="<%=jspVendor.colNames[JspVendor.JSP_TYPE]%>" value="0">
						  <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td class="container"><table width="100%" border="0" cellspacing="0" cellpadding="0">
					   ...
					   %>
                                  ...
                                  <tr align="left"> 
                                    <td height="21" width="10%">&nbsp;Due Date</td>
                                    <td height="21" colspan="2" width="90%"> 
