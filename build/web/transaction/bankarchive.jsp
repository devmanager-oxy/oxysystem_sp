                                          ...
                                          <td colspan="4" valign="top"> 
                                            <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                              ...
                                              <tr> 
                                                ...
                                                <td width="51%"> 
                                                  <%
												//out.println("bankArchive.getStartDate() : "+bankArchive.getStartDate());
												//out.println("bankArchive.getEndDate() : "+bankArchive.getEndDate());
												%>
                                                  <%=JSPDate.drawDateWithStyle(jspBankArchive.colNames[jspBankArchive.JSP_START_DATE], (bankArchive.getStartDate()==null) ? new Date() : bankArchive.getStartDate(), 0,-10, "formElemen", "") %> &nbsp;&nbsp;&nbsp;&nbsp;to&nbsp;&nbsp;&nbsp;&nbsp; 
                                                  <%=JSPDate.drawDateWithStyle(jspBankArchive.colNames[jspBankArchive.JSP_END_DATE], (bankArchive.getEndDate()==null) ? new Date() : bankArchive.getEndDate(), 0,-10, "formElemen", "") %> 
                                              ...
                                              <tr> 
                                                ...
                                                <td width="51%"> <%=JSPDate.drawDateWithStyle(jspBankArchive.colNames[jspBankArchive.JSP_TRANSACTION_DATE], (bankArchive.getTransactionDate()==null) ? new Date() : bankArchive.getTransactionDate(), 0,-10, "formElemen", "") %> 
