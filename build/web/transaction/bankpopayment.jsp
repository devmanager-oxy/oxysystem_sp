...
//	CmdBankpoPaymentDetail ctrlBankpoPaymentDetail = new CmdBankpoPaymentDetail(request);
	...
	if(invoices!=null && invoices.size()>0){		
		for(int i=0; i<invoices.size(); i++){			
			...
			//Receive pi = (Receive)invoices.get(i);
                                                ...
                                                <td width="100%" class="page"> 
                                                  <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                                    <tr> 
                                                      ...
                                                      <td  class="tablehdr" width="8%" nowrap>Invoice/<br>
                                                        DO Number </td>
                                                      <td class="tablehdr" width="8%" nowrap>Vendor</td>
                                                      <td class="tablehdr" width="7%" nowrap>Inv. 
                                                        Currency</td>
                                                      <td class="tablehdr" width="9%">Balance</td>
                                                      <td class="tablehdr" width="4%" nowrap> 
                                                        Rate </td>
                                                      <td class="tablehdr" width="9%">Balance 
                                                        <%=baseCurrency.getCurrencyCode()%></td>
                                                      <td class="tablehdr" width="9%">Payment 
                                                        <%=baseCurrency.getCurrencyCode()%></td>
                                                      <td class="tablehdr" width="11%">Payment 
                                                        by Invoice<br>
                                                        Currency</td>
                                                      <td class="tablehdr" width="33%">Description</td>
                                                    </tr>
                                                    <%if(invoices!=null && invoices.size()>0){
													for(int i=0; i<invoices.size(); i++){
														Vector v = (Vector)invoices.get(i);
												...
												%>
                                                    <tr> 
                                                      ...
                                                      <td class="tablecell" width="8%"> 
                                                        <div align="center"> <%=invoice.getInvoiceNumber()+"/"+invoice.getDoNumber()%> </div>
                                                      </td>
                                                      <td width="8%" class="tablecell" nowrap><%=vxxx.getName()%></td>
