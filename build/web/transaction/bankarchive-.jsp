                                            ...
                                            <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                              ...
                                              <tr> 
												...
												%>
                                                  ...
                                                  <input name="abc" value="<%=JSPFormater.formatDate((bankArchive.getStartDate()==null) ? new Date() : bankArchive.getStartDate(), "dd/MM/yyyy")%>" size="11">
                                                  <a href="javascript:void(0)" onClick="if(self.gfPop)gfPop.fPopCalendar(document.frmbankarchive.abc);return false;" ><img class="PopcalTrigger" align="absmiddle" src="<%=approot%>/calendar/calbtn.gif" height="19" border="0" alt="start date"></a> 
                                                  &nbsp;&nbsp;&nbsp;&nbsp;to&nbsp;&nbsp;&nbsp;&nbsp; 
