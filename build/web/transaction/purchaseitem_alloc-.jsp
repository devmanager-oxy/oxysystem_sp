...
if(oidPurchase==0){
	...
	if(purchase.getOID()==0){
		Vector v = DbPurchase.list(0,0, "purchase_id = "+oidPurchase, "");
		if(v!=null && v.size()>0){
			purchase = (Purchase)v.get(0);			
		}
	}
}

out.println("oidPurchase : "+oidPurchase+", x : "+purchase.getVendorId());
...
out.println("<br>purchase.getOID() : "+purchase.getOID());
                                  ...
                                  <tr align="left" valign="top"> 
                                      ...
                                      <table width="100%" border="0" cellspacing="1" cellpadding="0">
                                        ...
                                        <tr> 
                                          ...
                                          <td width="11%" height="22">Purchase 
                                            Number</td>
                                          <td width="44%" height="22"><%=purchase.getNumber()%></td>
                                        </tr>
                                        <tr> 
                                          <td width="10%" height="22">Deliver 
                                            To</td>
                                          <td width="35%" height="22"><b><i> </i></b></td>
                                          <td width="11%" height="22">Transaction 
                                            Date</td>
                                          <td width="44%" height="22"><%=JSPFormater.formatDate(purchase.getDate(), "dd/MM/yyyy")%></td>
                                        </tr>
                                        <tr> 
                                                      ...
                                                      <td width="100%" class="page"> 
                                                        <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                                          <tr> 
                                                            ...
                                                            <td  class="tablehdr" nowrap width="12%" height="20">Type</td>
                                                            <td  class="tablehdr" nowrap width="18%" height="20">Account 
                                                              - Description</td>
                                                            <td class="tablehdr" width="10%" height="20">Department</td>
									...
									if(((iJSPCommand==JSPCommand.EDIT || iJSPCommand==JSPCommand.ASK) || (iJSPCommand==JSPCommand.SAVE && iErrCode!=0)) && crd.getOID()==oidPurchaseItem){%>
                                                          <tr> 
                                                            <td class="tablecell" width="18%"> 
                                                              <div align="center"> 
                                                                <input type="text" name="<%=jspPurchaseItem.colNames[jspPurchaseItem.JSP_ITEM_NAME]%>" size="30" value="<%=crd.getItemName()%>">
                                                                <%= jspPurchaseItem.getErrorMsg(jspPurchaseItem.JSP_ITEM_NAME) %> </div>
                                                            </td>
                                                            <td class="tablecell" width="12%"> 
                                                              <div align="center"> 
                                                                <select name="<%=jspPurchaseItem.colNames[jspPurchaseItem.JSP_ITEM_TYPE]%>" onChange="javascript:cmdUpdateType()">
                                                                  <option value="<%=I_Project.ACC_LINK_GROUP_INVENTORY%>" <%if(I_Project.ACC_LINK_GROUP_INVENTORY.equals(crd.getItemType())){%>selected<%}%>><%=I_Project.ACC_LINK_GROUP_INVENTORY%></option>
                                                                  <option value="<%=I_Project.ACC_LINK_GROUP_NON_INVENTORY%>" <%if(I_Project.ACC_LINK_GROUP_NON_INVENTORY.equals(crd.getItemType())){%>selected<%}%>><%=I_Project.ACC_LINK_GROUP_NON_INVENTORY%></option>
                                                                </select>
                                                              </div>
                                                            </td>
                                                            <td class="tablecell" width="18%"> 
                                                              <div align="center"> 
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                  <tr id="invacc"> 
                                                                    <td> 
                                                                      <div align="center"> 
                                                                        <select name="<%=jspPurchaseItem.colNames[jspPurchaseItem.JSP_COA_ID]%>">
                                                                          <%if(incomeCoas!=null && incomeCoas.size()>0){
																		for(int x=0; x<incomeCoas.size(); x++){
																		
																			AccLink acl = (AccLink)incomeCoas.get(x);
																			
																			if(acl.getType().equals(I_Project.ACC_LINK_GROUP_INVENTORY)){
																		
																				Coa coax = new Coa();//(Coa)incomeCoas.get(x);
																	...
																	%>
                                                                        ...
                                                                        <%= jspPurchaseItem.getErrorMsg(jspPurchaseItem.JSP_COA_ID) %></div>
                                                                    </td>
                                                                  </tr>
                                                                  <tr id="noninvacc"> 
                                                                    <td> 
                                                                      <div align="center"> 
                                                                        <select name="<%=jspPurchaseItem.colNames[jspPurchaseItem.JSP_COA_ID_2]%>">
                                                                          <%if(incomeCoas!=null && incomeCoas.size()>0){
																		for(int x=0; x<incomeCoas.size(); x++){
																			
																			AccLink acl = (AccLink)incomeCoas.get(x);
																			
																			if(acl.getType().equals(I_Project.ACC_LINK_GROUP_NON_INVENTORY)){
                                                            ...
                                                            <td width="10%" class="tablecell" nowrap> 
                                                              <select name="<%=jspPurchaseItem.colNames[jspPurchaseItem.JSP_DEPARTMENT_ID]%>" onChange="javascript:cmdDepartment()">
                                                              ...
                                                              <%= ((jspPurchaseItem.getErrorMsg(jspPurchaseItem.JSP_DEPARTMENT_ID)).length()>0) ? "<br>"+jspPurchaseItem.getErrorMsg(jspPurchaseItem.JSP_DEPARTMENT_ID) : "" %></td>
                                                            <td width="10%" class="tablecell" nowrap> 
                                                              <div align="center"> 
                                                          ...
                                                          <tr> 
                                                            ...
                                                            <td class="tablecell" nowrap width="12%"> 
                                                              <%=crd.getItemType()%> </td>
                                                            <td class="tablecell" nowrap width="18%"> 
                                                              <%=c.getCode()%> &nbsp;-&nbsp; 
                                                              <%=c.getName()%></td>
									...
									if((iJSPCommand==JSPCommand.ADD || (iJSPCommand==JSPCommand.SAVE && (iErrCode!=0 || iErrCodeMain!=0))) && oidPurchaseItem==0){%>
                                                          <tr> 
                                                            <td class="tablecell" width="18%"> 
                                                              <div align="center"> 
                                                                <input type="text" name="<%=jspPurchaseItem.colNames[jspPurchaseItem.JSP_ITEM_NAME]%>" size="30" value="<%=purchaseItem.getItemName()%>">
                                                                <%= jspPurchaseItem.getErrorMsg(jspPurchaseItem.JSP_ITEM_NAME) %> </div>
                                                            </td>
                                                            <td class="tablecell" width="12%"> 
                                                              <div align="center"> 
                                                                <select name="<%=jspPurchaseItem.colNames[jspPurchaseItem.JSP_ITEM_TYPE]%>" onChange="javascript:cmdUpdateType()">
                                                                  <option value="<%=I_Project.ACC_LINK_GROUP_INVENTORY%>" <%if(I_Project.ACC_LINK_GROUP_INVENTORY.equals(purchaseItem.getItemType())){%>selected<%}%>><%=I_Project.ACC_LINK_GROUP_INVENTORY%></option>
                                                                  <option value="<%=I_Project.ACC_LINK_GROUP_NON_INVENTORY%>" <%if(I_Project.ACC_LINK_GROUP_NON_INVENTORY.equals(purchaseItem.getItemType())){%>selected<%}%>><%=I_Project.ACC_LINK_GROUP_NON_INVENTORY%></option>
                                                                </select>
                                                              </div>
                                                            </td>
                                                            <td class="tablecell" width="18%"> 
                                                              <div align="center"> 
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                  <tr id="invacc"> 
																	...
																	%>
                                                                          <option value="<%=coax.getOID()%>" <%if(purchaseItem.getCoaId()==coax.getOID()){%>selected<%}%>><%=str+coax.getCode()+" - "+coax.getName()%></option>
                                                                          <%}}}%>
                                                                        </select>
                                                                        <%= jspPurchaseItem.getErrorMsg(jspPurchaseItem.JSP_COA_ID) %> 
                                                                      </div>
                                                                    </td>
                                                                  </tr>
                                                                  <tr id="noninvacc"> 
                                                              ...
                                                              <select name="<%=jspPurchaseItem.colNames[jspPurchaseItem.JSP_DEPARTMENT_ID]%>" onChange="javascript:cmdDepartment()">
                                                                ...
                                                                <%if(deps!=null && deps.size()>0){
																		for(int x=0; x<deps.size(); x++){
																			...
																			//}
																			%>
                                                                <option value="<%=d.getOID()%>" <%if(purchaseItem.getDepartmentId()==d.getOID()){%>selected<%}%>><%=str+d.getCode()+" - "+d.getName()%></option>
                                                                <%}}%>
                                                              </select>
                                                              <%= ((jspPurchaseItem.getErrorMsg(jspPurchaseItem.JSP_DEPARTMENT_ID)).length() > 0) ? "<br>"+jspPurchaseItem.getErrorMsg(jspPurchaseItem.JSP_DEPARTMENT_ID) : ""%></td>
                                                            <td width="10%" class="tablecell" nowrap> 
