                ...
                <td width="100%" valign="top"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
					  ...
					  String navigator = "<font class=\"lvl1\">Accrual Transaction</font><font class=\"tit1\">&nbsp;&raquo;&nbsp;<span class=\"lvl2\">Accrual Process</span></font>";
					  %>
                            ...
                            <tr align="left" valign="top"> 
                              <td height="8"  colspan="3" class="container"> 
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <td>
                                      <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                        <tr> 
                                          ...
                                          <td width="14%" class="tablehdr">Nama</td>
                                          <td width="9%" class="tablehdr">Anggaran</td>
                                          <td width="8%" class="tablehdr">Periode</td>
                                          <td width="15%" class="tablehdr">Jumlah 
                                            Akrual</td>
                                          <td width="17%" class="tablehdr">Debet 
                                            Akun</td>
                                          <td width="18%" class="tablehdr">Kredit 
                                            Akun</td>
                                          <td width="8%" class="tablehdr">Status 
                                            Akrual</td>
                                          <td width="9%" class="tablehdr">Proses</td>
                                        </tr>
                                        ...
                                        <tr> 
                                          <td colspan="9"> 
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                              <tr> 
                                                <td width="3%"><a href="javascript:cmdSubmit()"><img src="../images/ctr_line/BtnSave.jpg" width="21" border="0"></a></td>
                                                <td width="97%"><a href="javascript:cmdSubmit()">Save</a></td>
                                              </tr>
                                            </table>
                                          </td>
                                        </tr>
								  ...
								  <%}else{%>
								  <tr>
                                    <td>&nbsp;<font color="#0000FF">proses akrual 
                                      selesa</font>i, <a href="#">lihat arsip</a></td>
                                  </tr>
								  <%}%>
                                </table>
