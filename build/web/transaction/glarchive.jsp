...
<%
	...
	//out.println("glArchive.setIgnoreTransactionDate(1) : "+ glArchive.getIgnoreTransactionDate());	
	
	whereClause = "";//journal_type = "+I_Project.JOURNAL_TYPE_GENERAL_LEDGER;
	
	//modify where clause base on search for
	
	//out.println("getTransactionDate :"+glArchive.getTransactionDate());
                                          ...
                                          <td colspan="4" valign="top"> 
                                            <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                              ...
                                              <tr> 
                                                ...
                                                <td width="51%"> <%=JSPDate.drawDateWithStyle(jspGlArchive.colNames[jspGlArchive.JSP_START_DATE], (glArchive.getStartDate()==null) ? new Date() : glArchive.getStartDate(), 0,-10, "formElemen", "") %> &nbsp;&nbsp;&nbsp;&nbsp;to&nbsp;&nbsp;&nbsp;&nbsp; 
