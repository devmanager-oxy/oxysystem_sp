...
Vector temp = DbCashReceive.getSaldoDP(oidCus, oidAccount);
Vector vnds = DbVendor.list(0,0, "type=0",""); 
                ...
                <td width="100%" valign="top"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
					  ...
					  <%
					  String navigator = "<font class=\"lvl1\">DP</font><font class=\"tit1\">&nbsp;&raquo;&nbsp;<span class=\"lvl2\">Saldo DP</span></font>";
					  %>
                                  ...
                                  <tr> 
                                    <td colspan="2"> 
                                      <table width="51%" border="0" cellspacing="1" cellpadding="1">
                                        <tr> 
                                          <td width="47%" class="tablehdr">Supplier</td>
                                        ...
                                        <%
										 ...
										 if(temp!=null && temp.size()>0){
											for(int i=0; i<temp.size(); i++){
												...
												detail.setSaldoTitipan(cr.getAmount());
												objReport.add(detail);
												
											    tTotal = tTotal + cr.getAmount();
