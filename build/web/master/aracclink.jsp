...
<%
	...
	if (grpType.equals("All")){
		...
		//whereClause = "company_id = "+appSessUser.getCompanyOID()+" and ("+whereClause.substring(0, whereClause.length()-3)+")";
		whereClause = " ("+whereClause.substring(0, whereClause.length()-3)+")";
		
	}else{
		//whereClause = "company_id = "+appSessUser.getCompanyOID();
		//whereClause = whereClause + " and "+DbAccLink.colNames[DbAccLink.COL_TYPE] + " = '"+ grpType + "'"; 
	...
	// switch statement
	//iErrCode = cmdAccLink.action(iCommand , oidAccLink,  appSessUser.getUserOID(), appSessUser.getCompanyOID());
                ...
                <td width="100%" valign="top"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
					  ...
					  <%
					  String navigator = "<font class=\"lvl1\">Account Receivable</font><font class=\"tit1\">&nbsp;&raquo;&nbsp;<span class=\"lvl2\">Account Link</span></font>";
					  %>
