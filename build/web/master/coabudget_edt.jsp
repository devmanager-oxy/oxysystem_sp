...
if(iJSPCommand==JSPCommand.SAVE && listCoa!=null && listCoa.size()>0 && v!=null && v.size()>0){
	for(int i=0; i<listCoa.size(); i++){		
		...
		long oid = DbCoaBudget.processBudget(coax.getOID(), (yearx+1900), amn);			
	}	
}
                                    ...
                                    <td height="22" valign="middle" colspan="3" class="page"> 
                                      <table width="100%" border="0" cellpadding="1" height="20" cellspacing="1">
                                        ...
                                        <tr> 
                                          ...
                                          <td class="tablehdr" height="22"><%=yearx+1900%> 
                                          </td>
							  ...
							  %>
                                        <tr> 
                                          <td width="23%" class="<%=cssString%>" nowrap> 
											...
											<%
											CoaBudget cBudget = DbCoaBudget.getBudget(coa.getOID(), yearx+1900);
											
										  	%>
                                          <td class="<%=cssString%>"> 
                                            <%if(!coa.getStatus().equals("HEADER")){%>
                                            <div align="center"> 
                                              <input type="text" name="bgt_<%=coa.getOID()+"_"+(yearx+1900)%>" size="15" value="<%=(cBudget.getAmount()==0) ? "" : JSPFormater.formatNumber(cBudget.getAmount(), "#,###")%>" onClick="this.select()" onBlur="javascript:checkNumber(this)" style="text-align:right">
                                            </div>
                                            <%}%>
                                          </td>
