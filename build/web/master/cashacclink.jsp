...
<%!
	...
	public String drawList(int iCommand, JspAccLink frmObject, AccLink objEntity, Vector objectClass,  
			long accLinkId, long depID, String typeAccLink, boolean isPostableOnly, boolean cashPrivUpdate)
	{	
		...
		jsplist.addHeader("Account Type","30%");
		//jsplist.addHeader("Department Name","25%");
		jsplist.addHeader("Cash Account","35%");
		jsplist.addHeader("Location","35%");
		...
		} else
		{
			...
			//tempCoa = DbCoa.list(0,0, DbCoa.colNames[DbCoa.COL_DEPARTMENT_ID] + " = " + depID + " and "+ DbCoa.colNames[DbCoa.COL_STATUS] +" = 'POSTABLE' and "+ DbCoa.colNames[DbCoa.COL_ACCOUNT_GROUP] +" = 'Expense'", "CODE");	
		}*/
		...
		for (int i = 0; i < objectClass.size(); i++) 
		{
			...
			}else
			{
				...
				if(objAccLink.getDepartmentId()!=0){
					try 
					{
		...
		{ 
			...
			//rowx.add(JSPCombo.draw(frmObject.colNames[frmObject.JSP_DEPARTMENT_ID],null, ""+String.valueOf(objEntity.getDepartmentId()).trim(), dept_value , dept_key, "onChange=\"javascript:cmdDept()\"", "formElemen"));
			//rowx.add(JSPCombo.draw(frmObject.colNames[frmObject.JSP_DEPARTMENT_ID],null, ""+depID, dept_value , dept_key, "onChange=\"javascript:cmdDept()\"", "formElemen"));
                ...
                <td width="100%" valign="top"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
					  ...
					  <%
					  String navigator = "<font class=\"lvl1\">Cash</font><font class=\"tit1\">&nbsp;&raquo;&nbsp;<span class=\"lvl2\">Account Link</span></font>";
					  %>
                    ...
                    <tr> 
                      <td><!-- #BeginEditable "content" --> 
                        <form name="frmacclink" method ="post" action="">
                          ...
                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr align="left"> 
                              <td height="10" valign="top" colspan="4"></td>
                            </tr>
                            <tr align="left"> 
...
//								{
						%>
                                  <tr align="left" valign="top"> 
                                    ...
                                    <td height="22" valign="middle" colspan="3" width="99%"><%= drawList(iCommand, jspAccLink, accLink, listAccLink, oidAccLink, depID, typeAccLink, isPostableOnly, cashPrivUpdate)%> 
...
//								}
						...
						%>
								...
								%>
                                  ...
                                  <%						
						if(cashPrivUpdate && (iCommand!=JSPCommand.EDIT && iCommand!=JSPCommand.ADD && iCommand!=JSPCommand.ASK && iErrCode==0))
						{
					%>
                                  <tr align="left" valign="top"> 
                                    <td height="22" valign="middle" width="1%">&nbsp;</td>
                                    <td height="22" valign="middle" colspan="3" width="99%"> 
                                      <table width="40%" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr> 
                                          <td><a href="javascript:cmdAdd()"  onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('new','','../images/new2.gif',1)"><img src="../images/new.gif" name="new" width="71" height="22" border="0"></a></td>
                                        </tr>
                                      </table>
                                    </td>
                                  </tr>
