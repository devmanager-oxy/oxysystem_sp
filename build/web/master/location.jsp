...
%>
<%
boolean masterPriv = QrUserSession.isHavePriviledge(appSessUser.getUserOID(), AppMenu.M1_MENU_MASTER, AppMenu.M2_MENU_GENERAL_LOCATION);
boolean masterPrivView = appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_MENU_MASTER, AppMenu.M2_MENU_GENERAL_LOCATION, AppMenu.PRIV_VIEW);
boolean masterPrivUpdate = appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_MENU_MASTER, AppMenu.M2_MENU_GENERAL_LOCATION, AppMenu.PRIV_UPDATE);
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td class="title"><!-- #BeginEditable "title" --> 
                        <%
					  String navigator = "<font class=\"lvl1\">Master</font><font class=\"tit1\">&nbsp;&raquo;&nbsp;<span class=\"lvl2\">Location</span></font>";
					  %>
                                        ...
                                        <tr align="left" valign="top"> 
                                          <td height="22" valign="middle" colspan="3"> 
                                            <table width="70%" border="0" cellspacing="0" cellpadding="0">
                                              <tr> 
                                                <td class="boxed1"><%= drawList(listLocation,oidLocation)%></td>
                                              </tr>
                                            </table>
                                          </td>
                                        </tr>
                                    ...
                                    <td height="8" valign="middle" colspan="3"> 
                                      ...
                                      <table width="100%" border="0" cellspacing="1" cellpadding="0">
                                        ...
                                        <tr align="left"> 
                                          ...
                                          <td height="21" colspan="2" width="91%" valign="top"> 
                                            <textarea name="<%=jspLocation.colNames[JspLocation.JSP_DESCRIPTION] %>" class="formElemen" cols="120" rows="2"><%= location.getDescription() %></textarea>
                                        <tr align="left"> 
