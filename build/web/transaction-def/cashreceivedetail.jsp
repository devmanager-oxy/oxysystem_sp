                ...
                <td width="100%" valign="top"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
					  ...
					  <%
					  String navigator = "<font class=\"lvl1\">Cash</font><font class=\"tit1\">&nbsp;&raquo;&nbsp;<span class=\"lvl2\">Receipt</span></font>";
					  %>
                                      ...
                                      <table width="99%" border="0" cellspacing="0" cellpadding="0">
                                        <tr> 
                                          <td class="boxed1"> 
                                            <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                              <tr> 
                                                <td rowspan="2"  class="tablehdr" nowrap width="10%">Account 
                                                  - Description</td>
                                                <td colspan="2" class="tablehdr"> 
                                                  Currency</td>
                                                <td rowspan="2" class="tablehdr" width="12%">Booked 
                                                  Rate</td>
                                                <td rowspan="2" class="tablehdr" width="13%">Amount 
                                                  <%=baseCurrency.getCurrencyCode()%></td>
                                                <td rowspan="2" class="tablehdr" width="46%">Description</td>
                                              </tr>
                                              <tr> 
