...
function cmdFixing(){	
	...
	document.frminvoiceactivity.action="invoiceactivity.jsp";
...
function cmdInvoice(oid){
	<%if(cntActivity>0){%>
		...
		document.frminvoiceactivity.prev_command.value="<%=prevJSPCommand%>";
		document.frminvoiceactivity.action="invoiceprint.jsp";
		document.frminvoiceactivity.submit();
	<%}else{%>
                ...
                <td width="100%" valign="top"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
					  ...
					  <%
					  String navigator = "<font class=\"lvl1\">Account Payable</font><font class=\"tit1\">&nbsp;&raquo;&nbsp;<span class=\"lvl2\">Activity Preview</span></font>";
					  %>
