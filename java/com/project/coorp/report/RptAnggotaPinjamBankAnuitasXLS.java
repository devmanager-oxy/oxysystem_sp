...
public class RptAnggotaPinjamBankAnuitasXLS extends HttpServlet {
    ...
    */
    ...
    throws ServletException, java.io.IOException {
        ...
        wb.println("<Column ss:AutoFitWidth=\"0\" ss:Width=\"55.25\"/>");
        ...
        wb.println("<Cell ss:StyleID=\"s22\"/>");
        wb.println("<Cell ss:MergeAcross=\"1\" ss:StyleID=\"s32\"><Data ss:Type=\"String\">: "+rptKonstan.getPeminjam()+"</Data></Cell>");
        wb.println("<Cell ss:StyleID=\"s22\"/>");
        wb.println("<Cell ss:StyleID=\"s30\"><Data ss:Type=\"String\">NIK</Data></Cell>");
        wb.println("<Cell ss:StyleID=\"s30\"><Data ss:Type=\"String\">     : "+rptKonstan.getNik()+"</Data></Cell>");
        wb.println("</Row>");
        ...
        wb.println("<Row>");
        wb.println("<Cell ss:Index=\"2\" ss:StyleID=\"s21\"><Data ss:Type=\"String\">Bank</Data></Cell>");
        wb.println("<Cell ss:StyleID=\"s30\"/>");
        wb.println("<Cell ss:MergeAcross=\"2\" ss:StyleID=\"s30\"><Data ss:Type=\"String\">: "+rptKonstan.getBank()+" </Data></Cell>");
        ...
        wb.println("<Cell ss:StyleID=\"s23\"/>");
        wb.println("<Cell ss:StyleID=\"s30\"><Data ss:Type=\"String\">Bunga Kop.     </Data></Cell>");
        wb.println("<Cell ss:StyleID=\"s30\"><Data ss:Type=\"String\">     : "+rptKonstan.getBungaPinjamanKoperasi()+" % / tahun</Data></Cell>");
        wb.println("<Cell ss:StyleID=\"s31\"/>");
        wb.println("</Row>");
        
        wb.println("<Row ss:AutoFitHeight=\"0\" ss:Height=\"5.25\">");
        wb.println("<Cell ss:Index=\"2\" ss:StyleID=\"s21\"><Data ss:Type=\"String\"></Data></Cell>");
        wb.println("<Cell ss:StyleID=\"s21\"/>");
        wb.println("<Cell ss:StyleID=\"s21\"/>");
        wb.println("<Cell ss:StyleID=\"s21\"/>");
        wb.println("<Cell ss:StyleID=\"s23\"/>");
        ...
        wb.println("<Cell ss:Index=\"2\" ss:StyleID=\"s21\"><Data ss:Type=\"String\"></Data></Cell>");
        wb.println("<Cell ss:StyleID=\"s30\"/>");
        wb.println("<Cell ss:MergeAcross=\"1\" ss:StyleID=\"s30\"></Cell>");
        wb.println("<Cell ss:StyleID=\"s23\"/>");
        wb.println("<Cell ss:StyleID=\"s30\"><Data ss:Type=\"String\">Bunga Bank     </Data></Cell>");
        wb.println("<Cell ss:StyleID=\"s30\"><Data ss:Type=\"String\">     : "+rptKonstan.getBungaPinjamanBank()+" % / tahun</Data></Cell>");
        wb.println("<Cell ss:StyleID=\"s31\"/>");
        wb.println("</Row>");
        ...
        wb.println("<Row>");
            wb.println("<Cell ss:Index=\"2\" ss:StyleID=\"s39\"><Data ss:Type=\"String\"></Data></Cell>");
            wb.println("<Cell ss:MergeAcross=\"3\" ss:StyleID=\"s39\"><Data ss:Type=\"String\">Koperasi</Data></Cell>");
            wb.println("<Cell ss:MergeAcross=\"3\" ss:StyleID=\"s39\"><Data ss:Type=\"String\">Bank</Data></Cell>");
            wb.println("<Cell ss:StyleID=\"s39\"></Cell>");
            wb.println("<Cell ss:StyleID=\"s39\"></Cell>");
            wb.println("<Cell ss:StyleID=\"s39\"></Cell>");
            wb.println("<Cell ss:StyleID=\"s39\"></Cell>");
        wb.println("</Row>");
        ...
        if(vDetail!=null && vDetail.size()>0){
            for(int i=0;i<vDetail.size();i++){
                ...
                wb.println("<Row ss:Index=\""+(20+i)+"\">");
                wb.println("<Cell ss:Index=\"2\" ss:StyleID=\"s24\"><Data ss:Type=\"Number\">"+detail.getAngsuran()+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s26\"><Data ss:Type=\"Number\">"+JSPFormater.formatNumber(detail.getAngPokokKop(), "#,###.##")+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s26\"><Data ss:Type=\"Number\">"+JSPFormater.formatNumber(detail.getBungaKop(), "#,###.##")+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s26\"><Data ss:Type=\"Number\">"+JSPFormater.formatNumber(detail.getTotalAngsuranKop(), "#,###.##")+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s26\"><Data ss:Type=\"Number\">"+JSPFormater.formatNumber(detail.getSaldoKop(), "#,###.##")+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s26\"><Data ss:Type=\"Number\">"+JSPFormater.formatNumber(detail.getAngPokokBank(), "#,###.##")+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s26\"><Data ss:Type=\"Number\">"+JSPFormater.formatNumber(detail.getBungaBank(), "#,###.##")+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s26\"><Data ss:Type=\"Number\">"+JSPFormater.formatNumber(detail.getTotalAngsuranBank(), "#,###.##")+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s26\"><Data ss:Type=\"Number\">"+JSPFormater.formatNumber(detail.getSaldoBank(), "#,###.##")+"</Data></Cell>");
