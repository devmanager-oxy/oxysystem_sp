...
public class RptIRItemXLS extends HttpServlet {
    ...
    */
    ...
    throws ServletException, java.io.IOException {
        ...
        try{
            ...
            rptKonstan = (RptIRItem)session.getValue("KONSTAN");
        }catch(Exception ex){
        ...
        wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"5\" ss:StyleID=\"s40\"><Data ss:Type=\"String\">INCOMING REPORT BY ITEM</Data></Cell>");
        ...
        if(vDetail!=null && vDetail.size()>0){
            ...
            RptIRItemL detail = (RptIRItemL)vDetail.get(i);
