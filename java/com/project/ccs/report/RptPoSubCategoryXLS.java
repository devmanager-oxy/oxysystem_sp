...
public class RptPoSubCategoryXLS extends HttpServlet {
    ...
    */
    ...
    throws ServletException, java.io.IOException {
        ...
        try{
            ...
            rptKonstan = (RptPoSubCategory)session.getValue("KONSTAN");
        }catch(Exception ex){
        ...
        wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"4\" ss:StyleID=\"s43\"><Data ss:Type=\"String\">PO REPORT BY SUB CATEGORY</Data></Cell>");
        ...
        if(vDetail!=null && vDetail.size()>0){
            for(int i=0;i<vDetail.size();i++){
                RptPoSubCategoryL detail = (RptPoSubCategoryL)vDetail.get(i);
