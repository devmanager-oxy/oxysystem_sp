...
public class RptIRSubCategoryXLS extends HttpServlet {
    ...
    */
    ...
    throws ServletException, java.io.IOException {
        ...
        try{
            ...
            rptKonstan = (RptIRSubCategory)session.getValue("KONSTAN");
        }catch(Exception ex){
        ...
        wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"4\" ss:StyleID=\"s43\"><Data ss:Type=\"String\">INCOMING REPORT BY SUB CATEGORY</Data></Cell>");
        ...
        if(vDetail!=null && vDetail.size()>0){
            for(int i=0;i<vDetail.size();i++){
                RptIRSubCategoryL detail = (RptIRSubCategoryL)vDetail.get(i);
                    ...
                    wb.println("<Cell ss:StyleID=\"s63\"><Data ss:Type=\"String\">"+detail.getNoPo()+"</Data></Cell>");
