...
public class RptPoItemXLS extends HttpServlet {
    ...
    */
    ...
    throws ServletException, java.io.IOException {
        ...
        try{
            ...
            rptKonstan = (RptPoItem)session.getValue("KONSTAN");
        }catch(Exception ex){
        ...
        wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"5\" ss:StyleID=\"s40\"><Data ss:Type=\"String\">PO REPORT BY ITEM</Data></Cell>");
        ...
        if(vDetail!=null && vDetail.size()>0){
            ...
            RptPoItemL detail = (RptPoItemL)vDetail.get(i);
