...
public class RptITLocationXLS extends HttpServlet {
    ...
    */
    ...
    throws ServletException, java.io.IOException {
        ...
        wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"4\" ss:StyleID=\"s43\"><Data ss:Type=\"String\">ITEM TRANSFER BY SUPPLIER</Data></Cell>");
        ...
        if(rptKonstan.getIgnored()==1){
            ...
            wb.println("<Cell ss:StyleID=\"s26\"><Data ss:Type=\"String\">From Location</Data></Cell>");
            wb.println("<Cell ss:MergeAcross=\"1\" ss:StyleID=\"m25175646\"><Data ss:Type=\"String\">To Location</Data></Cell>");
        ...
        if(vDetail!=null && vDetail.size()>0){
            for(int i=0;i<vDetail.size();i++){
                RptITLocationL detail = (RptITLocationL)vDetail.get(i);
                ...
                wb.println("<Cell ss:MergeAcross=\"1\" ss:StyleID=\"m25175656\"><Data ss:Type=\"String\">"+detail.getToLocation()+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s28\"><Data ss:Type=\"String\">"+detail.getDoc()+"</Data></Cell>");
                wb.println("</Row>");
                
                tt = detail.getTotalDoc();
            }
        }
        ...
        wb.println("ss:Type=\"String\">Total Doc</Data></Cell>");
