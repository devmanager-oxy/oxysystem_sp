...
public class RptPoSupplierXLS extends HttpServlet {
    ...
    */
    ...
    throws ServletException, java.io.IOException {
        ...
        try{
            ...
            rptKonstan = (RptPoSupplier)session.getValue("KONSTAN");
        }catch(Exception ex){
        ...
        wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"4\" ss:StyleID=\"s43\"><Data ss:Type=\"String\">PO REPORT BY SUPPLIER</Data></Cell>");
        ...
        if(vDetail!=null && vDetail.size()>0){
            for(int i=0;i<vDetail.size();i++){
                RptPoSupplierL detail = (RptPoSupplierL)vDetail.get(i);
                ...
                wb.println("<Cell ss:MergeAcross=\"1\" ss:StyleID=\"m25175656\"><Data ss:Type=\"String\">"+detail.getSupplier()+"</Data></Cell>");
