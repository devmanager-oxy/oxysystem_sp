...
public class JSPFormater {
    ...
    public static String formatDate(Date date, int languange, String outFormat) {
        ...
        if(true){//languange==com.project.util.lang.I_Language.LANGUAGE_DEFAULT){
    ...
    public static void main(String[] arg){
        ...
        System.out.println("abc = 1,000,000.00");
        System.out.println(Double.parseDouble("1,000,000.00"));
