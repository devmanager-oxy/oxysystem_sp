...
public class JSPList {
    public JSPList() {
        ...
        cellStyle1=new String("cellStyle1");
    ...
    /**
     * Holds value of property cellStyle1.
     */
    private String cellStyle1;
    
    /**
     * Holds value of property headAdditionParam.
     */
    private String headAdditionParam;
    ...
    public String draw(int selectedIndex) {
        ...
        str = "<table width=\""+areaWidth+"\" class=\"" + areaStyle + "\" cellpadding=\"0\" cellspacing=\"0\"><tr><td><table width=\""+listWidth+"\" class=\"" + listStyle + "\" cellspacing=\""+cellSpacing+"\" border=\""+border+"\"><tr>";
        // create header
        for (int h = 0; h < header.size(); h++) {
            
            str = str + "<td width=\""+ headerWidth.get(h) +"\" class=\"" + headerStyle + "\" "+headAdditionParam+">" + (String)header.get(h) + "</td>";
        }
        str = str + "</tr>";
        //create list
        Vector tmpRow = new Vector(1, 1);
    ...
    public static int getNewOffset(int iJSPCommand, int totalItem, int maxOnList , int currentOffset){
        switch (iJSPCommand){
    ...
    /**
     * Getter for property cellStyle1.
     * @return Value of property cellStyle1.
     */
    ...
    /**
     * Setter for property cellStyle1.
     * @param cellStyle1 New value of property cellStyle1.
     */
    public void setCellStyle1(String cellStyle1) {
        this.cellStyle1 = cellStyle1;
    }
    
    /**
     * Getter for property headAdditionParam.
     * @return Value of property headAdditionParam.
     */
    public String getHeadAdditionParam() {
        return this.headAdditionParam;
    }
    
    /**
     * Setter for property headAdditionParam.
     * @param headAdditionParam New value of property headAdditionParam.
     */
    public void setHeadAdditionParam(String headAdditionParam) {
        this.headAdditionParam = headAdditionParam;
    }
