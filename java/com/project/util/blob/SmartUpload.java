...
//import com.project.db.ormlayer.*;
        ...
        do
        {
            ...
            if(isFile && fileName.length() > 0)
            {
                ...
                if(m_maxFileSize > (long)0 && (long)((m_endData - m_startData) + 1) > m_maxFileSize)
                    throw new SecurityException(String.valueOf((new StringBuffer("Size exceeded for this file : "+fileName+" : (1105) :"))));
            ...
            if(isFile)
            {
                com.project.util.blob.File newFile = new com.project.util.blob.File();
