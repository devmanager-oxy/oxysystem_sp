...
public class RptLaporanHutangDetailXLS extends HttpServlet {
    ...
    */
    ...
    throws ServletException, java.io.IOException {
        ...
        wb.println("<LastPrinted>2009-07-14T01:51:10Z</LastPrinted>");
        wb.println("<Created>2009-07-10T05:56:39Z</Created>");
        wb.println("<LastSaved>2009-07-14T01:52:09Z</LastSaved>");
        ...
        wb.println("<Column ss:AutoFitWidth=\"0\" ss:Width=\"76.5\" ss:Span=\"2\"/>");
        wb.println("<Column ss:Index=\"9\" ss:AutoFitWidth=\"0\" ss:Width=\"57\"/>");
        ...
        wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"6\" ss:StyleID=\"s36\"><Data ss:Type=\"String\">LAPORAN SALDO HUTANG</Data></Cell>");
        ...
        wb.println("</Row>");
        wb.println("<Row>");
        wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"6\" ss:StyleID=\"s37\"><Data ss:Type=\"String\">"+cmp.getName()+"</Data></Cell>");
        ...
        wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"6\" ss:StyleID=\"s21\"><Data ss:Type=\"String\">"+cmp.getAddress()+"</Data></Cell>");
        ...
        wb.println("</Row>");
        wb.println("<Row>");
        wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"3\" ss:StyleID=\"s28\"><Data ss:Type=\"String\">"+rptKonstan.getHutangDetail()+"</Data></Cell>");
        ...
        wb.println("<Cell ss:StyleID=\"s22\"/>");
        wb.println("<Cell ss:StyleID=\"s22\"/>");
        wb.println("<Cell ss:Index=\"13\" ss:StyleID=\"s22\"/>");
        wb.println("</Row>");
        wb.println("<Row>");
        wb.println("<Cell ss:Index=\"2\" ss:StyleID=\"s22\"/>");
        wb.println("<Cell ss:StyleID=\"s22\"/>");
        ...
        wb.println("<Cell ss:StyleID=\"s35\"><Data ss:Type=\"String\">Bank</Data></Cell>");
        wb.println("<Cell ss:StyleID=\"s35\"><Data ss:Type=\"String\">No Rekening</Data></Cell>");
        wb.println("<Cell ss:StyleID=\"s35\"><Data ss:Type=\"String\">Tanggal</Data></Cell>");
        wb.println("<Cell ss:StyleID=\"s35\"><Data ss:Type=\"String\">Total Pinjaman   </Data></Cell>");
        wb.println("<Cell ss:StyleID=\"s34\"><Data ss:Type=\"String\">Total Angsuran</Data></Cell>");
        wb.println("<Cell ss:StyleID=\"s35\"><Data ss:Type=\"String\">Saldo Piutang</Data></Cell>");
        wb.println("</Row>");
        
        if(vDetail!=null && vDetail.size()>0){
            for(int i=0;i<vDetail.size();i++){
                RptLaporanHutangDetail detail = (RptLaporanHutangDetail)vDetail.get(i);
                wb.println("<Row>");
                wb.println("<Cell ss:Index=\"2\" ss:StyleID=\"s24\"><Data ss:Type=\"Number\">"+(1+i)+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s40\"><Data ss:Type=\"String\">"+detail.getBank()+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s40\"><Data ss:Type=\"String\">"+detail.getNoRekening()+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s42\"><Data ss:Type=\"String\">"+JSPFormater.formatDate(detail.getTanggal(), "dd/MM/yyyy")+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s26\"><Data ss:Type=\"Number\">"+JSPFormater.formatNumber(detail.getTotalPinjaman(), "#,###.##")+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s26\"><Data ss:Type=\"Number\">"+JSPFormater.formatNumber(detail.getTotalAngsuran(), "#,###.##")+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s26\"><Data ss:Type=\"Number\">"+JSPFormater.formatNumber(detail.getSaldoPiutang(), "#,###.##")+"</Data></Cell>");
                wb.println("</Row>");
            }
        }
        ...
        wb.println("<Row>");
        wb.println("<Cell ss:Index=\"5\" ss:StyleID=\"s55\"><Data ss:Type=\"String\">TOTAL</Data></Cell>");
        wb.println("<Cell ss:StyleID=\"s56\"><Data ss:Type=\"Number\">"+JSPFormater.formatNumber(rptKonstan.getTotalPinjamanHutangDetail(), "#,###.##")+"</Data></Cell>");
        wb.println("<Cell ss:StyleID=\"s56\"><Data ss:Type=\"Number\">"+JSPFormater.formatNumber(rptKonstan.getTotalAngsuranHutangDetail(), "#,###.##")+"</Data></Cell>");
        wb.println("<Cell ss:StyleID=\"s56\"><Data ss:Type=\"Number\">"+JSPFormater.formatNumber(rptKonstan.getTotalSaldoHutangDetail(), "#,###.##")+"</Data></Cell>");
        wb.println("</Row>");
        wb.println("</Table>");
