 ...
 * @author  Suarjaya
 */
public class RptGLPDF extends HttpServlet {
    ...
    */
    ...
    throws ServletException, java.io.IOException {
        ...
        try {
            ...
            // Load GL
            String GlId = JSPRequestValue.requestString(request, "gl_id");
            long glId = Long.parseLong(GlId);
            Gl gl = DbGl.fetchExc(glId);
            System.out.println("GLId : "+GlId);
            
            // Load GL Detail
            Vector vectorList = DbGlDetail.list(0, DbGlDetail.getCount("")," gl_id = "+glId,"");
            ...
            // Load Structure                                  
            document.add(getTableHeader(oidCompany, pathImage, writer, document, vectorList, gl));              
            document.add(getTableHeaderContent1(writer, document, gl));
            Table tblContent = getTableHeaderContent(writer, document);                               
            getTableContent(tblContent, writer, document, vectorList, gl);                  
    ...
    public static Table getTableHeader(long companyOID, String pathImage, PdfWriter writer, Document document, Vector vectorList, Gl gl) throws BadElementException, DocumentException {         
        ...
        cellHeader = new Cell(new Chunk("GENERAL JOURNAL", fontTitle));
        cellHeader.setHorizontalAlignment(Cell.ALIGN_CENTER);
        cellHeader.setVerticalAlignment(Cell.ALIGN_MIDDLE);
        cellHeader.setBorderColor(whiteColor);
        cellHeader.setBackgroundColor(Color.WHITE);
        ...
        Periode periode = DbPeriode.getPeriodByTransDate(gl.getTransDate());
    ...
    public static Table getTableHeaderContent(PdfWriter writer, Document document) throws BadElementException, DocumentException {
        ...
        int widthHead[] = {10,14,1,18,5,15,7,15,15};
        ...
        cellHeaderContent = new Cell(new Chunk("Debet IDR",fontHeader));
        cellHeaderContent.setHorizontalAlignment(Cell.ALIGN_CENTER);
        cellHeaderContent.setVerticalAlignment(Cell.ALIGN_MIDDLE);
        cellHeaderContent.setBackgroundColor(headerColor);
        cellHeaderContent.setRowspan(2);
        ...
        cellHeaderContent = new Cell(new Chunk("Credit IDR",fontHeader));
        cellHeaderContent.setHorizontalAlignment(Cell.ALIGN_CENTER);
        cellHeaderContent.setVerticalAlignment(Cell.ALIGN_MIDDLE);
        cellHeaderContent.setBackgroundColor(headerColor);
        cellHeaderContent.setRowspan(2);        
    ...
    public static Table getTableHeaderContent1(PdfWriter writer, Document document, Gl gl) throws BadElementException, DocumentException {
        ...
        /*Add header row 1 Col 1*/
        Cell cellHeaderContent = new Cell(new Chunk("Journal Number",fontContent));
        ...
        /*Add header row 1 Col 2*/
        cellHeaderContent = new Cell(new Chunk(gl.getJournalNumber(),fontContent));
        cellHeaderContent.setHorizontalAlignment(Cell.ALIGN_LEFT);
        cellHeaderContent.setVerticalAlignment(Cell.ALIGN_MIDDLE);
        cellHeaderContent.setBorderColor(Color.WHITE);
        cellHeaderContent.setBackgroundColor(contentColor);
        ...
        /*Add header row 1 Col 4*/
        cellHeaderContent = new Cell(new Chunk("Reference Number",fontContent));
        cellHeaderContent.setHorizontalAlignment(Cell.ALIGN_LEFT);
        cellHeaderContent.setVerticalAlignment(Cell.ALIGN_MIDDLE);
        cellHeaderContent.setBorderColor(Color.WHITE);
        cellHeaderContent.setBackgroundColor(contentColor);            
        ...
        /*Add header row 1 Col 5*/
        String refNum = "-";
        System.out.println("ref Num :"+gl.getRefNumber());
        if (!gl.getRefNumber().trim().equalsIgnoreCase(""))
        {
            refNum = gl.getRefNumber();
        }
        cellHeaderContent = new Cell(new Chunk(refNum,fontContent));
        cellHeaderContent.setHorizontalAlignment(Cell.ALIGN_LEFT);
        cellHeaderContent.setVerticalAlignment(Cell.ALIGN_MIDDLE);
        cellHeaderContent.setBorderColor(Color.WHITE);
        cellHeaderContent.setBackgroundColor(contentColor);     
        ...
        /*Add header row 2 Col 2*/
        cellHeaderContent = new Cell(new Chunk(JSPFormater.formatDate(gl.getTransDate(), "dd-MMM-yyyy"),fontContent));
        cellHeaderContent.setHorizontalAlignment(Cell.ALIGN_LEFT);
        cellHeaderContent.setVerticalAlignment(Cell.ALIGN_MIDDLE);
        cellHeaderContent.setBorderColor(Color.WHITE);
        cellHeaderContent.setBackgroundColor(contentColor);
        ...
        /*Add header row 3 Col 2*/
        cellHeaderContent = new Cell(new Chunk(gl.getMemo(),fontContent));
        cellHeaderContent.setHorizontalAlignment(Cell.ALIGN_LEFT);
        cellHeaderContent.setVerticalAlignment(Cell.ALIGN_MIDDLE);
        cellHeaderContent.setBorderColor(Color.WHITE);
        cellHeaderContent.setBackgroundColor(contentColor);
    ...
    public static void getTableContent(Table tableContent, PdfWriter writer, Document document, Vector vectorList, Gl gl) throws BadElementException, DocumentException {
        for(int i=0; i<vectorList.size(); i++){
            GlDetail glDetail = (GlDetail)vectorList.get(i);
            ...
            try{    
            dx = DbDepartment.fetchExc(glDetail.getDepartmentId());
            }
            catch(Exception e){ System.out.println(e); }

            Cell cellContent = new Cell(new Chunk((glDetail.getDepartmentId()==0) ? "0.0.0.0 - Total Corporate" : dx.getCode()+" - "+dx.getName(),fontContent));
            cellContent.setHorizontalAlignment(Cell.ALIGN_LEFT);
            cellContent.setVerticalAlignment(Cell.ALIGN_MIDDLE);
            cellContent.setBackgroundColor(contentColor);            
            tableContent.addCell(cellContent);            
            ...
            /*Add header row 1 Col 2*/
                ...
                try{	
                    curr = DbCurrency.fetchExc(glDetail.getForeignCurrencyId());
                }
                catch(Exception e){}
            ...
            /*Add header row 1 Col 3*/
            cellContent = new Cell(new Chunk(JSPFormater.formatNumber(glDetail.getForeignCurrencyAmount(), "#,###.##"),fontContent));
            ...
            /*Add header row 1 Col 4*/
            cellContent = new Cell(new Chunk(JSPFormater.formatNumber(glDetail.getBookedRate(), "#,###.##"),fontContent));
            cellContent.setHorizontalAlignment(Cell.ALIGN_RIGHT);
            cellContent.setVerticalAlignment(Cell.ALIGN_MIDDLE);
            cellContent.setBackgroundColor(contentColor);            
            tableContent.addCell(cellContent);
            ...
            /*Add header row 1 Col 5*/
            cellContent = new Cell(new Chunk(JSPFormater.formatNumber(glDetail.getDebet(), "#,###.##"),fontContent));
            cellContent.setHorizontalAlignment(Cell.ALIGN_RIGHT);
            cellContent.setVerticalAlignment(Cell.ALIGN_MIDDLE);
            cellContent.setBackgroundColor(contentColor);            
            tableContent.addCell(cellContent);
            ...
            cellContent = new Cell(new Chunk(JSPFormater.formatNumber(glDetail.getCredit(), "#,###.##"),fontContent));
            cellContent.setHorizontalAlignment(Cell.ALIGN_RIGHT);
            cellContent.setVerticalAlignment(Cell.ALIGN_MIDDLE);
            cellContent.setBackgroundColor(contentColor);              
            tableContent.addCell(cellContent);
        ...
        while(!endRows){
            ...
            if(endRows){
                ...
                /*Add header row 1 Col 5*/
                cellContent = new Cell(new Chunk("TOTAL",fontHeader));
                cellContent.setHorizontalAlignment(Cell.ALIGN_CENTER);
                cellContent.setVerticalAlignment(Cell.ALIGN_MIDDLE);
                cellContent.setBorderColor(Color.BLACK);
                ...
                /*Add header row 1 Col 6*/
                double totalDebet = getTotalDetail(vectorList, 0);
                cellContent = new Cell(new Chunk(JSPFormater.formatNumber(totalDebet, "#,###.##"),fontHeader));
                cellContent.setHorizontalAlignment(Cell.ALIGN_RIGHT);
                cellContent.setVerticalAlignment(Cell.ALIGN_MIDDLE);
                cellContent.setBorderColor(Color.BLACK);
                //cellContent.setBorder(Cell.BOTTOM | Cell.TOP | Cell.RIGHT);
                ...
                /*Add header row 1 Col 6*/
                double totalCredit = getTotalDetail(vectorList, 1);
                cellContent = new Cell(new Chunk(JSPFormater.formatNumber(totalCredit, "#,###.##"),fontHeader));
                cellContent.setHorizontalAlignment(Cell.ALIGN_RIGHT);
                cellContent.setVerticalAlignment(Cell.ALIGN_MIDDLE);
                cellContent.setBorderColor(Color.BLACK);
                //cellContent.setBorder(Cell.BOTTOM | Cell.TOP | Cell.RIGHT);
