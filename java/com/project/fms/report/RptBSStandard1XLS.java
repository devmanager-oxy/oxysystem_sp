...
public class RptBSStandard1XLS extends HttpServlet {
    ...
    */
    ...
    throws ServletException, java.io.IOException {
        ...
        if(idAccClass==DbCoa.ACCOUNT_CLASS_SP){
            titleH = "SIMPAN PINJAM";
        }else{
            titleH = "NON SIMPAN PINJAM";
        }
	...
	int colSpan = 0;
        ...
        wb.println("      <Cell ss:Index=\"2\" ss:MergeAcross=\""+(colSpan+2)+"\" ss:StyleID=\"s42\"><Data ss:Type=\"String\">NERACA UNIT "+titleH+"</Data></Cell>");
        wb.println("     </Row>");
