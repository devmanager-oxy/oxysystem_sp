...
public class RptAnggotaPinjamBankPdf extends HttpServlet {
  ...
  //==========================end================================
            ...
            titleCellTop.setVerticalAlignment(Element.ALIGN_MIDDLE);
            titleCellTop.setBorderColor(new Color(255,255,255));
            titleCellTop.setColspan(4);
            purchaseTable.addCell(titleCellTop);

            //Peminjam
            titleCellTop = new Cell(new Chunk("Peminjam", tableContent));
            titleCellTop.setHorizontalAlignment(Element.ALIGN_LEFT);
            titleCellTop.setVerticalAlignment(Element.ALIGN_MIDDLE);
            titleCellTop.setBorderColor(new Color(255,255,255));
            purchaseTable.addCell(titleCellTop);
            ...
            titleCellTop = new Cell(new Chunk("Bunga Pinjaman", tableContent));
            titleCellTop.setHorizontalAlignment(Element.ALIGN_LEFT);
            titleCellTop.setVerticalAlignment(Element.ALIGN_MIDDLE);
            titleCellTop.setBorderColor(new Color(255,255,255));
            purchaseTable.addCell(titleCellTop);
            ...
            titleCellTop = new Cell(new Chunk(rptKonstan.getBungaPinjaman()+" % / tahun", tableContent));
            titleCellTop.setHorizontalAlignment(Element.ALIGN_LEFT);
            titleCellTop.setVerticalAlignment(Element.ALIGN_MIDDLE);
            titleCellTop.setBorderColor(new Color(255,255,255));
            purchaseTable.addCell(titleCellTop);
 ...
 //Listnya
        ...
        if(vDetail!=null && vDetail.size()>0){
                    ...
                    //membuat table
                    int poHeaderTop[] = { 5,15,15,15,15,15,10,10,10};
                    ...
                    Cell titlePrCellTop = new Cell(new Chunk("Ang.", fontHeader));
                    titlePrCellTop.setHorizontalAlignment(Element.ALIGN_CENTER);
                    titlePrCellTop.setVerticalAlignment(Element.ALIGN_MIDDLE);
                    titlePrCellTop.setBorderColor(blackColor);
                    titlePrCellTop.setBackgroundColor(bgColor);
                ...
                for(int i=0;i<vDetail.size();i++){
                   ...
                   /* int n = (i+1);
                    ...
                    titlePrCellTop = new Cell(new Chunk(JSPFormater.formatNumber(detail.getAngPokok(), "#,###.##") , tableContent));
                    titlePrCellTop.setHorizontalAlignment(Element.ALIGN_RIGHT);
                    titlePrCellTop.setVerticalAlignment(Element.ALIGN_MIDDLE);
                    titlePrCellTop.setBorderColor(blackColor);
                    prTable.addCell(titlePrCellTop);

                    titlePrCellTop = new Cell(new Chunk(JSPFormater.formatNumber(detail.getBunga(), "#,###.##"), tableContent));
                    titlePrCellTop.setHorizontalAlignment(Element.ALIGN_RIGHT);
                    titlePrCellTop.setVerticalAlignment(Element.ALIGN_MIDDLE);
                    titlePrCellTop.setBorderColor(blackColor);
                    prTable.addCell(titlePrCellTop);

                    titlePrCellTop = new Cell(new Chunk(JSPFormater.formatNumber(detail.getKwjbAngsuran(), "#,###.##") , tableContent));
                    titlePrCellTop.setHorizontalAlignment(Element.ALIGN_RIGHT);
                    titlePrCellTop.setVerticalAlignment(Element.ALIGN_MIDDLE);
                    titlePrCellTop.setBorderColor(blackColor);
                    prTable.addCell(titlePrCellTop);

                    titlePrCellTop = new Cell(new Chunk(JSPFormater.formatNumber(detail.getSaldo(), "#,###.##") , tableContent));
                    titlePrCellTop.setHorizontalAlignment(Element.ALIGN_RIGHT);
                    titlePrCellTop.setVerticalAlignment(Element.ALIGN_MIDDLE);
                    titlePrCellTop.setBorderColor(blackColor);
                    prTable.addCell(titlePrCellTop);
