 ...
 * @author  Suarjaya
 */
public class RptBSDetailPDF extends HttpServlet {
    
    /** Creates a new instance of RptSampleFlatPDF */
    public RptBSDetailPDF() {
    }
    ...
    */
    ...
    public static Table getTableHeaderContent(PdfWriter writer, Document document) throws BadElementException, DocumentException {
        ...
        int widthHead[] = {7,10,10,43,15,15,0};
    ...
    public static void getTableContent(Table tableContent, PdfWriter writer, Document document, Vector vectorList, long oidCompany, String pathImage) throws BadElementException, DocumentException {
        for(int i=0; i<vectorList.size(); i++){
            ...
            if (srb.getTemp().equals("Detail Header")){
                ...
                /*Add header row 1 Col 2*/
                cellContent = new Cell(new Chunk("Transaction Date",fontContentBold));                
                cellContent.setHorizontalAlignment(Cell.ALIGN_CENTER);
                cellContent.setVerticalAlignment(Cell.ALIGN_MIDDLE);
                cellContent.setBorderColor(whiteColor);
                cellContent.setBackgroundColor(contentColor);
                ...
                /*Add header row 1 Col 3*/
                cellContent = new Cell(new Chunk("Journal Number",fontContentBold));                
                cellContent.setHorizontalAlignment(Cell.ALIGN_CENTER);
                cellContent.setVerticalAlignment(Cell.ALIGN_MIDDLE);
                cellContent.setBorderColor(whiteColor);
                cellContent.setBackgroundColor(contentColor);
                ...
                cellContent = new Cell(new Chunk("Memo",fontContentBold));                
                cellContent.setHorizontalAlignment(Cell.ALIGN_CENTER);
                cellContent.setVerticalAlignment(Cell.ALIGN_MIDDLE);
                cellContent.setBorderColor(whiteColor);
                cellContent.setBackgroundColor(contentColor);
                ...
                cellContent = new Cell(new Chunk("Amount",fontContentBold));                
                cellContent.setHorizontalAlignment(Cell.ALIGN_CENTER);
                cellContent.setVerticalAlignment(Cell.ALIGN_MIDDLE);
                cellContent.setBorderColor(whiteColor);
                cellContent.setBackgroundColor(contentColor);
                ...
                cellContent = new Cell(new Chunk("Balance",fontContentBold));                
                cellContent.setHorizontalAlignment(Cell.ALIGN_CENTER);
                cellContent.setVerticalAlignment(Cell.ALIGN_MIDDLE);
                cellContent.setBorderColor(whiteColor);
                cellContent.setBackgroundColor(contentColor);
            ...
            if (srb.getTemp().equals("Detail")){
                ...
                /*Add header row 1 Col 2*/
                cellContent = new Cell(new Chunk(JSPFormater.formatDate(srb.getTransDate(), "dd MMM yyyy"),fontContent));                
                cellContent.setHorizontalAlignment(Cell.ALIGN_CENTER);
                cellContent.setVerticalAlignment(Cell.ALIGN_MIDDLE);
                cellContent.setBorderColor(whiteColor);
                cellContent.setBackgroundColor(contentColor);
                ...
                /*Add header row 1 Col 5*/
                cellContent = new Cell(new Chunk(strDisplay(srb.getAmount(),""),fontContent));                
                cellContent.setHorizontalAlignment(Cell.ALIGN_RIGHT);
                cellContent.setVerticalAlignment(Cell.ALIGN_MIDDLE);
                cellContent.setBorderColor(whiteColor);
                cellContent.setBackgroundColor(contentColor);
            ...
            if (srb.getTemp().equals("Detail Footer")){
                ...
                /*Add header row 1 Col 2*/
                cellContent = new Cell(new Chunk(strDisplay(srb.getAmount(),""),fontContentBold));                
                cellContent.setHorizontalAlignment(Cell.ALIGN_RIGHT);
                cellContent.setVerticalAlignment(Cell.ALIGN_MIDDLE);
                cellContent.setBorderColor(whiteColor);
                cellContent.setBackgroundColor(contentColor);
                ...
                /*Add header row 1 Col 3*/
                cellContent = new Cell(new Chunk(strDisplay(srb.getBalance(),""),fontContentBold));                
                cellContent.setHorizontalAlignment(Cell.ALIGN_RIGHT);
                cellContent.setVerticalAlignment(Cell.ALIGN_MIDDLE);
                cellContent.setBorderColor(whiteColor);
                cellContent.setBackgroundColor(contentColor);
