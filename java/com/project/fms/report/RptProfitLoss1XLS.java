...
public class RptProfitLoss1XLS extends HttpServlet {
    ...
    */
    ...
    throws ServletException, java.io.IOException {
        ...
        try{
            ...
            vectorList = (Vector)session.getValue("PROFIT1");
	...
	if(vDep!=null && vDep.size()>0){
        ...
        wb.println("     <Row>");
        wb.println("      <Cell ss:Index=\"2\" ss:MergeDown=\"1\" ss:StyleID=\"s41\"><Data ss:Type=\"String\">Description</Data></Cell>");
        wb.println("      <Cell ss:MergeDown=\"1\" ss:StyleID=\"s41\"><Data ss:Type=\"String\">P &amp; L &#10;Prev. Period</Data></Cell>");
        ...
        wb.println("      <Cell ss:MergeDown=\"1\" ss:StyleID=\"s41\"><Data ss:Type=\"String\">Total Corporate</Data></Cell>");
        wb.println("     </Row>");
        wb.println("     <Row>");
        int firstSecCol = 0;
        if(vDep!=null && vDep.size()>0){
            for(int i=0; i<vDep.size(); i++){
                ...
                if(vSec!=null && vSec.size()>0){
                    for(int ia=0; ia<vSec.size(); ia++){
                        Department depSec = (Department)vSec.get(ia);												
                        if(firstSecCol==0)
                            wb.println("      <Cell ss:Index=\"4\" ss:StyleID=\"s41\"><Data ss:Type=\"String\">"+depSec.getName()+"</Data></Cell>");
                        else
                            wb.println("      <Cell ss:StyleID=\"s41\"><Data ss:Type=\"String\">"+depSec.getName()+"</Data></Cell>");
                        firstSecCol = firstSecCol+1;
                    }
                }else if(firstSecCol==0){
                    wb.println("      <Cell ss:Index=\"4\" ss:StyleID=\"s41\"><Data ss:Type=\"String\"></Data></Cell>");
                }else{
