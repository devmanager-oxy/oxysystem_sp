 ...
 *
 * Created on January 17, 2007, 11:28 AM
 */
 ...
 * @author  Suarjaya
 */
public class RptAccPaymentPDF extends HttpServlet {
    
    /** Creates a new instance of RptSampleFlatPDF */
    public RptAccPaymentPDF() {
    }
    ...
    */
    ...
    throws ServletException, java.io.IOException {
        ...
        try {
            ...
            try{
                vectorList = DbInvoiceItem.list(0, DbInvoiceItem.getCount("")," invoice_id = "+invoiceId,"");
    ...
    public static Table getTableHeader(long companyOID, String pathImage, PdfWriter writer, Document document, Vector vectorList, Invoice invoice) throws BadElementException, DocumentException {         
        ...
        cellHeader = new Cell(new Chunk("ACCOUNT PAYABLE", fontTitle));
        cellHeader.setHorizontalAlignment(Cell.ALIGN_CENTER);
        cellHeader.setVerticalAlignment(Cell.ALIGN_MIDDLE);
        cellHeader.setBorderColor(whiteColor);
        cellHeader.setBackgroundColor(Color.WHITE);
    ...
    public static Table getTableHeaderContent(PdfWriter writer, Document document) throws BadElementException, DocumentException {
        ...
        //int widthHead[] = {14,9,17,16,5,13,13,13};
        int widthHead[] = {14,9,10,16,5,13,13,20};
...
/*        cellHeaderContent = new Cell(new Chunk("Account - Description",fontHeader));
    ...
    public static void getTableContent(Table tableContent, PdfWriter writer, Document document, Vector vectorList, Invoice invoice) throws BadElementException, DocumentException {
        for(int i=0; i<vectorList.size(); i++){
            InvoiceItem invItem = (InvoiceItem)vectorList.get(i);

            /*Add header row 1 Col 1*/
            Cell cellContent = new Cell(new Chunk(invItem.getItemName(),fontContent));
            ...
            /*Add header row 1 Col 2*/
/*            cellContent = new Cell(new Chunk(invItem.getItemType(),fontContent));
...
/*                Coa c = new Coa();
                try{	
                    c = DbCoa.fetchExc(invItem.getCoaId());
                }
                catch(Exception e){}                
            ...
            try{    
            dx = DbDepartment.fetchExc(invItem.getDepartmentId());
            }
            catch(Exception e){ System.out.println(e); }
            cellContent = new Cell(new Chunk((invItem.getDepartmentId()==0) ? "0.0.0.0 - Total Corporate" : dx.getCode()+" - "+dx.getName(),fontContent));
            cellContent.setHorizontalAlignment(Cell.ALIGN_LEFT);
            cellContent.setVerticalAlignment(Cell.ALIGN_MIDDLE);
            cellContent.setBackgroundColor(contentColor);            
            tableContent.addCell(cellContent);
            ...
            /*Add header row 1 Col 4*/
            cellContent = new Cell(new Chunk(JSPFormater.formatNumber(invItem.getInvQty(), "#,###.##"),fontContent));
            cellContent.setHorizontalAlignment(Cell.ALIGN_CENTER);
            cellContent.setVerticalAlignment(Cell.ALIGN_MIDDLE);
            cellContent.setBackgroundColor(contentColor);            
            tableContent.addCell(cellContent);
            ...
            /*Add header row 1 Col 5*/
            cellContent = new Cell(new Chunk(JSPFormater.formatNumber(invItem.getPrice(), "#,###.##"),fontContent));
            ...
            /*Add header row 1 Col 6*/
            cellContent = new Cell(new Chunk(JSPFormater.formatNumber(invItem.getTotal(), "#,###.##"),fontContent));
            cellContent.setHorizontalAlignment(Cell.ALIGN_RIGHT);
            cellContent.setVerticalAlignment(Cell.ALIGN_MIDDLE);
            cellContent.setBackgroundColor(contentColor);            
            tableContent.addCell(cellContent);
            ...
            /*Add header row 1 Col 7*/
            cellContent = new Cell(new Chunk(invItem.getMemo(),fontContent));
            cellContent.setHorizontalAlignment(Cell.ALIGN_LEFT);
            cellContent.setVerticalAlignment(Cell.ALIGN_MIDDLE);
            cellContent.setBackgroundColor(contentColor);            
            tableContent.addCell(cellContent);
...
/*            cellContent = new Cell(new Chunk("",fontContent));
            ...
            if(endRows){
                ...
                /*Add header row 1 Col 2*/
                cellContent = new Cell(new Chunk("SUB TOTAL",fontDate1));
                cellContent.setHorizontalAlignment(Cell.ALIGN_CENTER);
                cellContent.setVerticalAlignment(Cell.ALIGN_MIDDLE);
                cellContent.setBorderColor(Color.BLACK);
                ...
                /*Add header row 1 Col 3*/
                cellContent = new Cell(new Chunk(JSPFormater.formatNumber(invoice.getSubTotal(), "#,###.##"),fontDate1));                
                cellContent.setHorizontalAlignment(Cell.ALIGN_RIGHT);
                cellContent.setVerticalAlignment(Cell.ALIGN_MIDDLE);
                cellContent.setBorderColor(Color.BLACK);
                //cellContent.setBorder(Cell.BOTTOM | Cell.TOP | Cell.RIGHT);
                ...
                /*Add header row 3 Col 3*/
                cellContent = new Cell(new Chunk(JSPFormater.formatNumber(invoice.getVatPercent(), "#,###.##") + " %",fontDate1));
                cellContent.setHorizontalAlignment(Cell.ALIGN_RIGHT);
                cellContent.setVerticalAlignment(Cell.ALIGN_MIDDLE);
                cellContent.setBorderColor(Color.BLACK);
                //cellContent.setBorder(Cell.BOTTOM | Cell.TOP | Cell.RIGHT);
                ...
                /*Add header row 3 Col 4*/
                cellContent = new Cell(new Chunk(JSPFormater.formatNumber(invoice.getVatAmount(), "#,###.##"),fontDate1));
                cellContent.setHorizontalAlignment(Cell.ALIGN_RIGHT);
                cellContent.setVerticalAlignment(Cell.ALIGN_MIDDLE);
                cellContent.setBorderColor(Color.BLACK);
                //cellContent.setBorder(Cell.BOTTOM | Cell.TOP | Cell.RIGHT);
                ...
                cellContent = new Cell(new Chunk(JSPFormater.formatNumber(invoice.getGrandTotal(), "#,###.##"),fontDate1));
                cellContent.setHorizontalAlignment(Cell.ALIGN_RIGHT);
                cellContent.setVerticalAlignment(Cell.ALIGN_MIDDLE);
                cellContent.setBorderColor(Color.BLACK);
                //cellContent.setBorder(Cell.BOTTOM | Cell.TOP | Cell.RIGHT);
