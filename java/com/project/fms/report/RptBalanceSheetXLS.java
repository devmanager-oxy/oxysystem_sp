...
public class RptBalanceSheetXLS extends HttpServlet {
    ...
    */
	...
	int colSpan = 0;
        ...
        wb.println("    <Column ss:AutoFitWidth=\"0\" ss:Width=\"159\" ss:Span=\""+(colSpan)+"\"/>");
        ...
        wb.println("      <Cell ss:Index=\"2\" ss:MergeAcross=\""+(colSpan+1)+"\" ss:StyleID=\"s42\"><Data ss:Type=\"String\">BALANCE SHEET</Data></Cell>");
        wb.println("     </Row>");
        ...
        String openPeriod = JSPFormater.formatDate(dtx, "MMM yyyy")+ " - " + JSPFormater.formatDate(periode.getStartDate(), "MMM yyyy");
