 ...
 * @author  Suarjaya
 */
public class RptBSMultiplePDF extends HttpServlet {
    
    /** Creates a new instance of RptSampleFlatPDF */
    public RptBSMultiplePDF() {
    }
    ...
    */
    ...
    throws ServletException, java.io.IOException {
        ...
        try {
            ...
            Vector temp = DbPeriode.list(0,6, where, "start_date");
            Vector temp1 = DbPeriode.list(6,6, where, "start_date");
            System.out.println("Total vPeriod 1 : "+temp.size());
            System.out.println("Total vPeriod 2 : "+temp1.size());
            ...
            try{
                ...
                vectorList = (Vector)session.getValue("BS_MULTIPLE");
            ...
            Table tblContent = getTableHeaderContent(writer, document, temp);                               
            getTableContent(tblContent, writer, document, vectorList, oidCompany, pathImage, temp);                  
 
            if(temp1.size()>0){
                // Load Structure 
                document.newPage();                                             
                document.add(getTableHeader(oidCompany, pathImage, writer, document));              
                Table tblContentx = getTableHeaderContent(writer, document, temp1);                               
                getTableContent(tblContentx, writer, document, vectorList, oidCompany, pathImage, temp1);                  
            }
    ...
    public static Table getTableHeaderContent(PdfWriter writer, Document document, Vector vDep) throws BadElementException, DocumentException {
	...
	//vDep = DbDepartment.list(0,0,"level=0","code");
        ...
        {
            case 1 :
                int widthHead1[] = {210,50,0,0};
                tableHeaderContent.setWidths(widthHead1);
                break;            
            case 2 :
                int widthHead2[] = {210,50,50,0,0};
                tableHeaderContent.setWidths(widthHead2);
                break;            
            case 3 :
                int widthHead3[] = {210,50,50,50,0,0};
                tableHeaderContent.setWidths(widthHead3);
                break;            
            case 4 :
                int widthHead4[] = {210,50,50,50,50,0,0};
                tableHeaderContent.setWidths(widthHead4);
                break;            
            case 5 :
                int widthHead5[] = {210,50,50,50,50,50,0,0};
                tableHeaderContent.setWidths(widthHead5);
                break;            
            case 6 :
                int widthHead6[] = {210,50,50,50,50,50,50,0,0};
                tableHeaderContent.setWidths(widthHead6);
                break;            
            case 7 :
                int widthHead7[] = {210,50,50,50,50,50,50,50,0,0};
                tableHeaderContent.setWidths(widthHead7);
                break;            
            case 8 :
                int widthHead8[] = {210,50,50,50,50,50,50,50,50,0,0};
                tableHeaderContent.setWidths(widthHead8);
                break;            
            case 9 :
                int widthHead9[] = {210,50,50,50,50,50,50,50,50,50,0,0};
                tableHeaderContent.setWidths(widthHead9);
                break;            
            case 10 :
                int widthHead10[] = {210,50,50,50,50,50,50,50,50,50,50,0,0};
                tableHeaderContent.setWidths(widthHead10);
                break;            
            case 11 :
                int widthHead11[] = {210,50,50,50,50,50,50,50,50,50,50,50,0,0};
                tableHeaderContent.setWidths(widthHead11);
                break;            
            case 12 :
                int widthHead12[] = {210,50,50,50,50,50,50,50,50,50,50,50,50,0,0};
                tableHeaderContent.setWidths(widthHead12);
                break;            
            case 13 :
                int widthHead13[] = {210,50,50,50,50,50,50,50,50,50,50,50,50,50,0,0};
                tableHeaderContent.setWidths(widthHead13);
                break;            
            case 14 :
                int widthHead14[] = {210,50,50,50,50,50,50,50,50,50,50,50,50,50,50,0,0};
                tableHeaderContent.setWidths(widthHead14);
                break;
            case 15 :
                int widthHead15[] = {210,50,50,50,50,50,50,50,50,50,50,50,50,50,50,50,0,0};
                tableHeaderContent.setWidths(widthHead15);
                break;            
            default :
                int widthHead0[] = {210,0,0};
                tableHeaderContent.setWidths(widthHead0);
        }
        
        //int widthHead[] = {210,50,50,50,50,50,50,50,50,0,0};
    ...
    public static void getTableContent(Table tableContent, PdfWriter writer, Document document, Vector vectorList, long oidCompany, String pathImage, Vector vDep) throws BadElementException, DocumentException {       
        ...
        for(int i=0; i<vectorList.size(); i++){
            ...
            if(!writer.fitsPage(tableContent)){
                ...
                document.newPage();
                document.add(getTableHeader(oidCompany, pathImage, writer, document));                              
                tableContent = getTableHeaderContent(writer,document,vDep);                                    
            }         
        }
