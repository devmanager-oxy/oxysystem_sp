...
public class RptBSMultipleXLS extends HttpServlet {
    ...
    */
    ...
    throws ServletException, java.io.IOException {
        ...
        System.out.println("Total vPeriod : "+vDep.size());
	...
	int colSpan = vDep.size();
        ...
        wb.println("    <Column ss:AutoFitWidth=\"0\" ss:Width=\"128.75\" ss:Span=\""+(colSpan-1)+"\"/>");
        wb.println("    <Column ss:Index=\""+(colSpan+3)+"\" ss:AutoFitWidth=\"0\" ss:Width=\"14.25\"/>");
        ...
        wb.println("     <Row>"); 
        wb.println("      <Cell ss:Index=\""+(colSpan+2)+"\" ss:StyleID=\"s28\"><Data ss:Type=\"String\">Printed : "+JSPFormater.formatDate(new Date(),formatDate)+"</Data></Cell>");
        wb.println("     </Row>");
        wb.println("     <Row ss:Height=\"23.25\">");
        wb.println("      <Cell ss:Index=\"2\" ss:MergeAcross=\""+(colSpan)+"\" ss:StyleID=\"s40\"><Data ss:Type=\"String\" x:Ticked=\"1\">"+company.getName().toUpperCase()+"</Data></Cell>");
        wb.println("     </Row>");
        wb.println("     <Row ss:Height=\"20.25\">");
        wb.println("      <Cell ss:Index=\"2\" ss:MergeAcross=\""+(colSpan)+"\" ss:StyleID=\"s42\"><Data ss:Type=\"String\">BALANCE SHEET</Data></Cell>");
        wb.println("     </Row>");
        ...
        wb.println("      <Cell ss:Index=\"2\" ss:MergeAcross=\""+(colSpan)+"\" ss:StyleID=\"s43\"><Data ss:Type=\"String\">MULTIPLE PERIODS</Data></Cell>");
        wb.println("     </Row>");
        ...
        //footer
        wb.println("     <Row>");
        wb.println("      <Cell ss:Index=\"2\" ss:MergeAcross=\""+(colSpan)+"\" ss:StyleID=\"s47\"><Data ss:Type=\"String\"></Data></Cell>");
        wb.println("     </Row>");
        wb.println("     <Row>");
        wb.println("      <Cell ss:Index=\"2\" ss:MergeAcross=\""+(colSpan)+"\" ss:StyleID=\"s47\"><Data ss:Type=\"String\"></Data></Cell>");
        wb.println("     </Row>");
        wb.println("     <Row>");
        wb.println("      <Cell ss:Index=\"2\" ss:MergeAcross=\""+(colSpan)+"\" ss:StyleID=\"s47\"><Data ss:Type=\"String\">Date : _________________                Date : _________________                Date : _________________</Data></Cell>");
        wb.println("     </Row>");
        wb.println("     <Row>");
        wb.println("      <Cell ss:Index=\"2\" ss:MergeAcross=\""+(colSpan)+"\" ss:StyleID=\"s47\"><Data ss:Type=\"String\">Approve by                                            Review by                                            Prepare by</Data></Cell>");
        wb.println("     </Row>");
        wb.println("     <Row>");
        wb.println("      <Cell ss:Index=\"2\" ss:MergeAcross=\""+(colSpan)+"\" ss:StyleID=\"s47\"><Data ss:Type=\"String\"></Data></Cell>");
        wb.println("     </Row>");
        ...
        wb.println("     </Row>");
        wb.println("     <Row>");
        wb.println("      <Cell ss:Index=\"2\" ss:MergeAcross=\""+(colSpan)+"\" ss:StyleID=\"s47\"><Data ss:Type=\"String\">______________________                ______________________                ______________________</Data></Cell>");
        wb.println("     </Row>");       
