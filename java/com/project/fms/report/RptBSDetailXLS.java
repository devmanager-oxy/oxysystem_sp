/*
 * Report BS Detail XLS.java
 *
 * Created on March 26, 2008, 1:33 AM
 */
...
public class RptBSDetailXLS extends HttpServlet {
    ...
    */
    ...
    throws ServletException, java.io.IOException {
        ...
        try{
            ...
            vectorList = (Vector)session.getValue("BS_DETAIL");
	...
	int colSpan = 0;
        ...
        wb.println("     <Style ss:ID=\"m16935920\">");
        ...
        wb.println("     <Style ss:ID=\"m16931246\">");
        ...
        wb.println("     <Style ss:ID=\"m16931256\">");
        wb.println("      <Alignment ss:Horizontal=\"Left\" ss:Vertical=\"Center\"/>");
        wb.println("      <Borders>");
        wb.println("       <Border ss:Position=\"Bottom\" ss:LineStyle=\"Continuous\" ss:Weight=\"1\"/>");
        wb.println("       <Border ss:Position=\"Left\" ss:LineStyle=\"Continuous\" ss:Weight=\"1\"/>");
        ...
        wb.println("     <Style ss:ID=\"m16931266\">");
        ...
        wb.println("     <Style ss:ID=\"m16931276\">");
        wb.println("      <Alignment ss:Horizontal=\"Right\" ss:Vertical=\"Center\"/>");
        wb.println("      <Borders>");
        wb.println("       <Border ss:Position=\"Bottom\" ss:LineStyle=\"Continuous\" ss:Weight=\"1\"/>");
        wb.println("       <Border ss:Position=\"Left\" ss:LineStyle=\"Continuous\" ss:Weight=\"1\"/>");
        ...
        wb.println("    <Table>");
        //wb.println("    <Column ss:AutoFitWidth=\"0\" ss:Width=\"346.25\"/>");
        //wb.println("    <Column ss:AutoFitWidth=\"0\" ss:Width=\"108.75\" ss:Span=\""+(colSpan)+"\"/>");
        //wb.println("    <Column ss:Index=\""+(colSpan+4)+"\" ss:Hidden=\"1\" ss:AutoFitWidth=\"0\" ss:Span=\""+(256-colSpan-4)+"\"/>");
        wb.println("      <Column ss:AutoFitWidth=\"0\" ss:Width=\"14.25\"/>");
        wb.println("      <Column ss:AutoFitWidth=\"0\" ss:Width=\"64.5\"/>");
        wb.println("      <Column ss:AutoFitWidth=\"0\" ss:Width=\"102\" ss:Span=\"1\"/>");
        wb.println("      <Column ss:Index=\"5\" ss:AutoFitWidth=\"0\" ss:Width=\"370.5\"/>");
        wb.println("      <Column ss:StyleID=\"s21\" ss:AutoFitWidth=\"0\" ss:Width=\"129\" ss:Span=\"1\"/>");
        wb.println("      <Column ss:Index=\"8\" ss:AutoFitWidth=\"0\" ss:Width=\"14.25\"/>");
        wb.println("      <Column ss:Hidden=\"1\" ss:AutoFitWidth=\"0\" ss:Span=\"245\"/>");
        wb.println("      <Column ss:Index=\"255\" ss:Hidden=\"1\" ss:AutoFitWidth=\"0\" ss:Span=\"1\"/>");
        ...
        wb.println("      <Row>");
        wb.println("       <Cell ss:Index=\"7\"><Data ss:Type=\"String\">Printed : 26 March 2008</Data></Cell>");
        wb.println("      </Row>");
        wb.println("      <Row ss:AutoFitHeight=\"0\" ss:Height=\"23.25\">");
        wb.println("       <Cell ss:Index=\"2\" ss:MergeAcross=\"5\" ss:StyleID=\"s24\"><Data ss:Type=\"String\"");
        wb.println("         x:Ticked=\"1\">"+company.getName().toUpperCase()+"</Data></Cell>");
        wb.println("      </Row>");
        wb.println("      <Row ss:AutoFitHeight=\"0\" ss:Height=\"20.25\">");
        wb.println("       <Cell ss:Index=\"2\" ss:MergeAcross=\"5\" ss:StyleID=\"s26\"><Data ss:Type=\"String\">BALANCE SHEET</Data></Cell>");
        wb.println("      </Row>");
        ...
        wb.println("       <Cell ss:Index=\"2\" ss:MergeAcross=\"5\" ss:StyleID=\"s28\"><Data ss:Type=\"String\">PERIOD "+ openPeriod.toUpperCase()+"</Data></Cell>");
        wb.println("      </Row>");
        
        //Content Header
        wb.println("      <Row ss:AutoFitHeight=\"0\" ss:Height=\"15\"/>");
        wb.println("      <Row>");
        wb.println("       <Cell ss:Index=\"2\" ss:MergeAcross=\"3\" ss:StyleID=\"m16935920\"><Data");
        wb.println("         ss:Type=\"String\">Description</Data></Cell>");
        wb.println("       <Cell ss:MergeAcross=\"1\" ss:StyleID=\"s80\"><Data ss:Type=\"String\">Total Corporate</Data></Cell>");
        wb.println("      </Row>");
        ...
        for(int i=0; i<vectorList.size(); i++){
            ...
            if (srb.getTemp().equalsIgnoreCase("Standard")){
                wb.println("     <Row>");        
                wb.println("      <Cell ss:Index=\"2\" ss:MergeAcross=\"3\" ss:StyleID=\""+xFont+"\"><Data ss:Type=\"String\">"+srb.getDescription()+"</Data></Cell>");
                ...
                wb.println("      <Cell ss:MergeAcross=\"1\" ss:StyleID=\""+xFont1+"\"><Data ss:Type=\"Number\">"+dblAmount+"</Data></Cell>");   
                //wb.println("      <Cell ss:MergeAcross=\"1\" ss:StyleID=\""+xFont1+"\"><Data ss:Type=\"Number\"></Data></Cell>");   
                wb.println("     </Row>");       
            }
            
            //detail content
            if (srb.getTemp().equals("Detail Header")){
                wb.println("      <Row>");
                wb.println("       <Cell ss:Index=\"2\" ss:StyleID=\"s98\"/>");
                wb.println("       <Cell ss:StyleID=\"s86\"><Data ss:Type=\"String\">Transaction Date</Data></Cell>");
                wb.println("       <Cell ss:StyleID=\"s86\"><Data ss:Type=\"String\">Journal Number</Data></Cell>");
                wb.println("       <Cell ss:StyleID=\"s86\"><Data ss:Type=\"String\">Memo</Data></Cell>");
                wb.println("       <Cell ss:StyleID=\"s86\"><Data ss:Type=\"String\">Amount</Data></Cell>");
                wb.println("       <Cell ss:StyleID=\"s87\"><Data ss:Type=\"String\">Balance</Data></Cell>");
                wb.println("      </Row>");

            }
            if (srb.getTemp().equals("Detail")){
                wb.println("      <Row>");
                wb.println("       <Cell ss:Index=\"2\" ss:StyleID=\"s99\"/>");
                wb.println("       <Cell ss:StyleID=\"s88\"><Data ss:Type=\"DateTime\">"+srb.getTransDate()+"</Data></Cell>");
                wb.println("       <Cell ss:StyleID=\"s89\"><Data ss:Type=\"String\">"+srb.getJournalNumber()+"</Data></Cell>");
                wb.println("       <Cell ss:StyleID=\"s85\"><Data ss:Type=\"String\">"+srb.getMemo()+"</Data></Cell>");
                wb.println("       <Cell ss:StyleID=\"s90\"><Data ss:Type=\"Number\">"+srb.getAmount()+"</Data></Cell>");
                wb.println("       <Cell ss:StyleID=\"s90\"><Data ss:Type=\"Number\">"+srb.getBalance()+"</Data></Cell>");
                wb.println("      </Row>   ");                
            }
            if (srb.getTemp().equals("Detail Footer")){
                wb.println("      <Row>");
                wb.println("       <Cell ss:Index=\"2\" ss:StyleID=\"s100\"/>");
                wb.println("       <Cell ss:MergeAcross=\"2\" ss:StyleID=\"s91\"><Data ss:Type=\"String\">Total</Data></Cell>");
                wb.println("       <Cell ss:StyleID=\"s92\"><Data ss:Type=\"Number\">"+srb.getAmount()+"</Data></Cell>");
                wb.println("       <Cell ss:StyleID=\"s92\"><Data ss:Type=\"Number\">"+srb.getBalance()+"</Data></Cell>");
                wb.println("      </Row>");            
            }
        }
        ...
        //footer
        wb.println("      <Row>");
        wb.println("       <Cell ss:Index=\"2\" ss:MergeAcross=\"5\" ss:StyleID=\"s36\"><Data ss:Type=\"String\"></Data></Cell>");
        wb.println("      </Row>");
        wb.println("      <Row>");
        wb.println("       <Cell ss:Index=\"2\" ss:MergeAcross=\"5\" ss:StyleID=\"s36\"><Data ss:Type=\"String\"></Data></Cell>");
        wb.println("      </Row>");
        wb.println("      <Row>");
        wb.println("       <Cell ss:Index=\"2\" ss:MergeAcross=\"5\" ss:StyleID=\"s36\"><Data ss:Type=\"String\">Date : _________________                                Date : _________________                                Date : _________________</Data></Cell>");
        wb.println("      </Row>");
        wb.println("      <Row>");
        wb.println("       <Cell ss:Index=\"2\" ss:MergeAcross=\"5\" ss:StyleID=\"s36\"><Data ss:Type=\"String\">Approve by                                                            Review by                                                            Prepare by</Data></Cell>");
        wb.println("      </Row>");
        wb.println("      <Row>");
        wb.println("       <Cell ss:Index=\"2\" ss:MergeAcross=\"5\" ss:StyleID=\"s36\"><Data ss:Type=\"String\"></Data></Cell>");
        wb.println("      </Row>");
        ...
        wb.println("      </Row>");
        wb.println("      <Row>");
        wb.println("       <Cell ss:Index=\"2\" ss:MergeAcross=\"5\" ss:StyleID=\"s36\"><Data ss:Type=\"String\">______________________                                ______________________                                ______________________</Data></Cell>");
        wb.println("      </Row>");
