...
public class RptProfitLoss0XLS extends HttpServlet {
    ...
    */
	...
	if(vDep!=null && vDep.size()>0){
        ...
        wb.println("      <Cell ss:Index=\"2\" ss:MergeAcross=\""+(colSpan+2)+"\" ss:StyleID=\"s43\"><Data ss:Type=\"String\">PERIOD "+ (JSPFormater.formatDate(startDate, "dd/MM/yyyy")+" - "+JSPFormater.formatDate(endDate, "dd/MM/yyyy"))+"</Data></Cell>");
        wb.println("     </Row>");
        ...
        wb.println("      <Cell ss:StyleID=\"s41\"><Data ss:Type=\"String\">P &amp; L &#10;Prev. Period</Data></Cell>");
        if(vDep!=null && vDep.size()>0){
            for(int i=0; i<vDep.size(); i++){
                Department dep = (Department)vDep.get(i);												
