...
public class RptPenjelasanNAXLS extends HttpServlet {
    ...
    */
	...
	int colSpan = 0;
        ...
        wb.println("      <Cell ss:Index=\"2\" ss:MergeAcross=\""+(colSpan+1)+"\" ss:StyleID=\"s42\"><Data ss:Type=\"String\">PENJELASAN NERACA AKHIR</Data></Cell>");
        wb.println("     </Row>");
        ...
        wb.println("      <Cell ss:Index=\"2\" ss:MergeAcross=\""+(colSpan+1)+"\" ss:StyleID=\"s43\"><Data ss:Type=\"String\">BULAN "+ openPeriod.toUpperCase()+"</Data></Cell>");
        wb.println("     </Row>");
