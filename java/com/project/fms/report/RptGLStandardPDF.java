    ...
    */
    ...
    throws ServletException, java.io.IOException {
        ...
        try {
            ...
            // Load Structure                                  
            document.add(getTableHeader(oidCompany, pathImage, writer, document,strPeriod));              
            Table tblContent = getTableHeaderContent(writer, document);                               
            getTableContent(tblContent, writer, document, vectorList, oidCompany, pathImage,strPeriod);                  
    ...
    public static Table getTableHeader(long companyOID, String pathImage, PdfWriter writer, Document document, String strPeriod) throws BadElementException, DocumentException {         
    ...
    public static void getTableContent(Table tableContent, PdfWriter writer, Document document, Vector vectorList, long oidCompany, String pathImage, String strPeriod) throws BadElementException, DocumentException {
        int iHeader = 0;
