 ...
 * @author  Suarjaya
 */
public class RptBanknonpoPaymentPDF extends HttpServlet {
    
    /** Creates a new instance of RptSampleFlatPDF */
    public RptBanknonpoPaymentPDF() {
    }
    ...
    */
    ...
    throws ServletException, java.io.IOException {
        ...
        try {
            ...
            // Load Bank Non Payment
            String BanknonpoPaymentId = JSPRequestValue.requestString(request, "nonpo_id");
            long banknonpoPaymentId = Long.parseLong(BanknonpoPaymentId);
            BanknonpoPayment banknonpoPayment = new BanknonpoPayment();
            try{
                banknonpoPayment = banknonpoPayment = DbBanknonpoPayment.fetchExc(banknonpoPaymentId);
            } catch (Exception e){ System.out.println(e); }
            System.out.println("BankNonPOPaymentId : "+BanknonpoPaymentId);
                       
            // Load Bank Non Payment Detail            
            Vector vectorList = new Vector(1,1);
            try{
                vectorList = DbBanknonpoPaymentDetail.list(0, DbBanknonpoPaymentDetail.getCount("")," banknonpo_payment_id = "+banknonpoPaymentId,"");
            ...
            // Load Structure                      
            document.add(getTableHeader(oidCompany, pathImage, writer, document, vectorList, banknonpoPayment));
            document.add(getTableHeaderContent1(writer, document, banknonpoPayment));                                            
            Table tblContent = getTableHeaderContent(writer, document);  
            getTableContent(tblContent, writer, document, vectorList, banknonpoPayment);                  
    ...
    public static Table getTableHeader(long companyOID, String pathImage, PdfWriter writer, Document document, Vector vectorList, BanknonpoPayment banknonpoPayment) throws BadElementException, DocumentException {         
        ...
        cellHeader = new Cell(new Chunk("BANK NON PO PAYMENT", fontTitle));
        cellHeader.setHorizontalAlignment(Cell.ALIGN_CENTER);
        cellHeader.setVerticalAlignment(Cell.ALIGN_MIDDLE);
        cellHeader.setBorderColor(whiteColor);
        cellHeader.setBackgroundColor(Color.WHITE);
        ...
        /*Add header row 3 Col 1*/        
        Periode periode = DbPeriode.getPeriodByTransDate(banknonpoPayment.getTransDate());
    ...
    public static Table getTableHeaderContent(PdfWriter writer, Document document) throws BadElementException, DocumentException {
        Table tableHeaderContent = new Table(9);      
               
        int widthHead[] = {10,14,18,5,15,7,15,10,6};
    ...
    public static Table getTableHeaderContent1(PdfWriter writer, Document document, BanknonpoPayment banknonpoPayment) throws BadElementException, DocumentException {
        ...
        if (banknonpoPayment.getType()==0)
        {
            ...
            Vendor v = new Vendor();
            try{
                    v = DbVendor.fetchExc(banknonpoPayment.getVendorId());
            }
            catch(Exception e){ System.out.println(e); }
        ...
        /*Add header row 1 Col 2*/
            Coa c = new Coa();
            try{	
                c = DbCoa.fetchExc(banknonpoPayment.getCoaId());
            }
            catch(Exception e){ System.out.println(e); }
        ...
        /*Add header row 1 Col 5*/
        cellHeaderContent = new Cell(new Chunk(banknonpoPayment.getJournalNumber(),fontContent));
        cellHeaderContent.setHorizontalAlignment(Cell.ALIGN_LEFT);
        cellHeaderContent.setVerticalAlignment(Cell.ALIGN_MIDDLE);
        cellHeaderContent.setBorderColor(Color.WHITE);
        cellHeaderContent.setBackgroundColor(contentColor);     
        ...
        /*Add header row 2 Col 1*/
        cellHeaderContent = new Cell(new Chunk("Pay Method",fontContent));
        cellHeaderContent.setHorizontalAlignment(Cell.ALIGN_LEFT);
        cellHeaderContent.setVerticalAlignment(Cell.ALIGN_MIDDLE);
        cellHeaderContent.setBorderColor(Color.WHITE);
        cellHeaderContent.setBackgroundColor(contentColor);            
        ...
        cellHeaderContent = new Cell(new Chunk(JSPFormater.formatDate(banknonpoPayment.getTransDate(), "dd-MMM-yyyy"),fontContent));
        cellHeaderContent.setHorizontalAlignment(Cell.ALIGN_LEFT);
        cellHeaderContent.setVerticalAlignment(Cell.ALIGN_MIDDLE);
        cellHeaderContent.setBorderColor(Color.WHITE);
        cellHeaderContent.setBackgroundColor(contentColor);
        ...
        /*Add header row 3 Col 1*/
        cellHeaderContent = new Cell(new Chunk("Bank Reference Number",fontContent));
        cellHeaderContent.setHorizontalAlignment(Cell.ALIGN_LEFT);
        cellHeaderContent.setVerticalAlignment(Cell.ALIGN_MIDDLE);
        cellHeaderContent.setBorderColor(Color.WHITE);
        cellHeaderContent.setBackgroundColor(contentColor);            
        ...
        /*Add header row 3 Col 2*/
        cellHeaderContent = new Cell(new Chunk(banknonpoPayment.getRefNumber(),fontContent));
        cellHeaderContent.setHorizontalAlignment(Cell.ALIGN_LEFT);
        cellHeaderContent.setVerticalAlignment(Cell.ALIGN_MIDDLE);
        cellHeaderContent.setBorderColor(Color.WHITE);
        cellHeaderContent.setBackgroundColor(contentColor);     
        ...
        cellHeaderContent = new Cell(new Chunk("Invoice Number",fontContent));
        cellHeaderContent.setHorizontalAlignment(Cell.ALIGN_LEFT);
        cellHeaderContent.setVerticalAlignment(Cell.ALIGN_MIDDLE);
        cellHeaderContent.setBorderColor(Color.WHITE);
        cellHeaderContent.setBackgroundColor(contentColor); 
        ...
        cellHeaderContent = new Cell(new Chunk((banknonpoPayment.getInvoiceNumber()==null) ? "-" : banknonpoPayment.getInvoiceNumber(),fontContent));
        cellHeaderContent.setHorizontalAlignment(Cell.ALIGN_LEFT);
        cellHeaderContent.setVerticalAlignment(Cell.ALIGN_MIDDLE);
        cellHeaderContent.setBorderColor(Color.WHITE);        
        cellHeaderContent.setBackgroundColor(contentColor);
        ...
        cellHeaderContent = new Cell(new Chunk(banknonpoPayment.getMemo(),fontContent));
        cellHeaderContent.setHorizontalAlignment(Cell.ALIGN_LEFT);
        cellHeaderContent.setVerticalAlignment(Cell.ALIGN_MIDDLE);
        cellHeaderContent.setBorderColor(Color.WHITE);
        cellHeaderContent.setBackgroundColor(contentColor);
    ...
    public static void getTableContent(Table tableContent, PdfWriter writer, Document document, Vector vectorList, BanknonpoPayment banknonpoPayment) throws BadElementException, DocumentException {
        for(int i=0; i<vectorList.size(); i++){
            BanknonpoPaymentDetail banknonpoPaymentDetail = (BanknonpoPaymentDetail)vectorList.get(i);
       
            // Load BanknonpoPaymentDetail list
            
            /*Add header row 1 Col 1*/
                Coa c = new Coa();
                try{	
                    c = DbCoa.fetchExc(banknonpoPaymentDetail.getCoaId());
                }
                catch(Exception e){ System.out.println(e); }
            ...
            try{    
            dx = DbDepartment.fetchExc(banknonpoPaymentDetail.getDepartmentId());
            }
            catch(Exception e){ System.out.println(e); }

            Cell cellContent = new Cell(new Chunk(dx.getCode()+" - "+dx.getName(),fontContent));
            cellContent.setHorizontalAlignment(Cell.ALIGN_LEFT);
            cellContent.setVerticalAlignment(Cell.ALIGN_MIDDLE);
            cellContent.setBackgroundColor(contentColor);            
            tableContent.addCell(cellContent);
            ...
            /*Add header row 1 Col 2*/
                ...
                try{	
                    curr = DbCurrency.fetchExc(banknonpoPaymentDetail.getForeignCurrencyId());
                }
                catch(Exception e){ System.out.println(e); }
            ...
            /*Add header row 1 Col 3*/
            cellContent = new Cell(new Chunk(JSPFormater.formatNumber(banknonpoPaymentDetail.getForeignAmount(), "#,###.##"),fontContent));
            ...
            /*Add header row 1 Col 4*/
            cellContent = new Cell(new Chunk(JSPFormater.formatNumber(banknonpoPaymentDetail.getBookedRate(), "#,###.##"),fontContent));
            cellContent.setHorizontalAlignment(Cell.ALIGN_RIGHT);
            cellContent.setVerticalAlignment(Cell.ALIGN_MIDDLE);
            cellContent.setBackgroundColor(contentColor);            
            tableContent.addCell(cellContent);
            ...
            /*Add header row 1 Col 5*/
            cellContent = new Cell(new Chunk(JSPFormater.formatNumber(banknonpoPaymentDetail.getAmount(), "#,###.##"),fontContent));
            cellContent.setHorizontalAlignment(Cell.ALIGN_RIGHT);
            cellContent.setVerticalAlignment(Cell.ALIGN_MIDDLE);
            cellContent.setBackgroundColor(contentColor);            
            tableContent.addCell(cellContent);
            ...
            cellContent = new Cell(new Chunk(banknonpoPaymentDetail.getMemo(),fontContent));
            cellContent.setHorizontalAlignment(Cell.ALIGN_LEFT);
            cellContent.setVerticalAlignment(Cell.ALIGN_MIDDLE);
            cellContent.setBackgroundColor(contentColor);  
            cellContent.setColspan(2);
        ...
        while(!endRows){
            ...
            if(endRows){
                ...
                /*Add header row 1 Col 6*/
                cellContent = new Cell(new Chunk(JSPFormater.formatNumber(banknonpoPayment.getAmount(), "#,###.##"),fontDate2));
                cellContent.setHorizontalAlignment(Cell.ALIGN_RIGHT);
                cellContent.setVerticalAlignment(Cell.ALIGN_MIDDLE);
                cellContent.setBorderColor(Color.BLACK);
                //cellContent.setBorder(Cell.BOTTOM | Cell.TOP | Cell.RIGHT);
