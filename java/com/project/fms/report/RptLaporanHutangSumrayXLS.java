...
public class RptLaporanHutangSumrayXLS extends HttpServlet {
    ...
    */
    ...
    throws ServletException, java.io.IOException {
        ...
        wb.println("<LastSaved>2009-07-14T01:55:31Z</LastSaved>");
        ...
        wb.println("<Column ss:AutoFitWidth=\"0\" ss:Width=\"138\"/>");
        wb.println("<Column ss:AutoFitWidth=\"0\" ss:Width=\"138.75\"/>");
        wb.println("<Column ss:AutoFitWidth=\"0\" ss:Width=\"145.5\"/>");
        ...
        wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"3\" ss:StyleID=\"s36\"><Data ss:Type=\"String\">LAPORAN SALDO HUTANG</Data></Cell>");
        ...
        wb.println("</Row>");
        wb.println("<Row>");
        wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"3\" ss:StyleID=\"s37\"><Data ss:Type=\"String\">"+cmp.getName()+"</Data></Cell>");
        ...
        wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"3\" ss:StyleID=\"s21\"><Data ss:Type=\"String\">"+cmp.getAddress()+"</Data></Cell>");
        ...
        wb.println("</Row>");
        wb.println("<Row>");
        wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"1\" ss:StyleID=\"s28\"><Data ss:Type=\"String\">"+rptKonstan.getSumrayHutang()+"</Data></Cell>");
        ...
        wb.println("<Cell ss:StyleID=\"s22\"/>");
        wb.println("<Cell ss:StyleID=\"s22\"/>");
        wb.println("<Cell ss:Index=\"10\" ss:StyleID=\"s22\"/>");
        wb.println("</Row>");
        wb.println("<Row>");
        wb.println("<Cell ss:Index=\"2\" ss:StyleID=\"s22\"/>");
        wb.println("<Cell ss:StyleID=\"s22\"/>");
        ...
        if(vDetail!=null && vDetail.size()>0){
            for(int i=0;i<vDetail.size();i++){
                RptLaporanHutangSumray detail = (RptLaporanHutangSumray)vDetail.get(i);
                wb.println("<Row>");
        ...
        wb.println("<Row>");
        wb.println("<Cell ss:Index=\"3\" ss:StyleID=\"s43\"><Data ss:Type=\"Number\">"+JSPFormater.formatNumber(rptKonstan.getTotalPinjamanSamHutang(), "#,###.##")+"</Data></Cell>");
        wb.println("<Cell ss:StyleID=\"s43\"><Data ss:Type=\"Number\">"+JSPFormater.formatNumber(rptKonstan.getTotalAngsuranSamHutang(), "#,###.##")+"</Data></Cell>");
        wb.println("<Cell ss:StyleID=\"s43\"><Data ss:Type=\"Number\">"+JSPFormater.formatNumber(rptKonstan.getTotalSaldoSamHutang(), "#,###.##")+"</Data></Cell>");
        wb.println("</Row>");
        wb.println("</Table>");
