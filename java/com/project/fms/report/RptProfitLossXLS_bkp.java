...
public class RptProfitLossXLS_bkp extends HttpServlet {
    ...
    */
	...
	int colSpan = 0;
        ...
        wb.println("    <Column ss:AutoFitWidth=\"0\" ss:Width=\"384.25\"/>");
        wb.println("    <Column ss:AutoFitWidth=\"0\" ss:Width=\"114\" ss:Span=\""+(colSpan+2)+"\"/>");
        wb.println("    <Column ss:Index=\""+(colSpan+6)+"\" ss:AutoFitWidth=\"0\" ss:Width=\"14.25\"/>");
        wb.println("    <Column ss:Hidden=\"1\" ss:AutoFitWidth=\"0\" ss:Span=\""+(256-colSpan-7)+"\"/>");
        ...
        wb.println("     <Row>"); 
        wb.println("      <Cell ss:Index=\""+(colSpan+5)+"\" ss:StyleID=\"s28\"><Data ss:Type=\"String\">Printed : "+JSPFormater.formatDate(new Date(),formatDate)+"</Data></Cell>");
        wb.println("     </Row>");
        
        wb.println("     <Row ss:Height=\"23.25\">");
        wb.println("      <Cell ss:Index=\"2\" ss:MergeAcross=\""+(colSpan+3)+"\" ss:StyleID=\"s40\"><Data ss:Type=\"String\" x:Ticked=\"1\">"+company.getName().toUpperCase()+"</Data></Cell>");
        wb.println("     </Row>");
        
        wb.println("     <Row ss:Height=\"20.25\">");
        wb.println("      <Cell ss:Index=\"2\" ss:MergeAcross=\""+(colSpan+3)+"\" ss:StyleID=\"s42\"><Data ss:Type=\"String\">"+strTitle+"</Data></Cell>");
        wb.println("     </Row>");
        ...
        wb.println("      <Cell ss:Index=\"2\" ss:MergeAcross=\""+(colSpan+3)+"\" ss:StyleID=\"s43\"><Data ss:Type=\"String\">PERIOD "+ openPeriod.toUpperCase()+"</Data></Cell>");
        wb.println("     </Row>");
        ...
        wb.println("      <Cell ss:MergeDown=\"0\" ss:StyleID=\"s41\"><Data ss:Type=\"String\">BLN INI</Data></Cell>");
        wb.println("      <Cell ss:MergeDown=\"0\" ss:StyleID=\"s41\"><Data ss:Type=\"String\">BLN INI</Data></Cell>");
        wb.println("      <Cell ss:MergeDown=\"0\" ss:StyleID=\"s41\"><Data ss:Type=\"String\">SD BLN INI</Data></Cell>");
        wb.println("     </Row>");
        ...
        for(int i=0; i<vectorList.size(); i++){
            ...
            wb.println("      <Cell ss:StyleID=\""+xFont1+"\"><Data ss:Type=\"Number\">"+dblAmountBudget+"</Data></Cell>");
            wb.println("      <Cell ss:StyleID=\""+xFont1+"\"><Data ss:Type=\"Number\">"+dblAmountMth+"</Data></Cell>");
        ...
        //footer
        wb.println("     <Row>");
        wb.println("      <Cell ss:Index=\"2\" ss:MergeAcross=\""+(colSpan+3)+"\" ss:StyleID=\"s47\"><Data ss:Type=\"String\"></Data></Cell>");
        wb.println("     </Row>");
        wb.println("     <Row>");
        wb.println("      <Cell ss:Index=\"2\" ss:MergeAcross=\""+(colSpan+3)+"\" ss:StyleID=\"s47\"><Data ss:Type=\"String\"></Data></Cell>");
        wb.println("     </Row>");
        wb.println("     <Row>");
        wb.println("      <Cell ss:Index=\"2\" ss:MergeAcross=\""+(colSpan+3)+"\" ss:StyleID=\"s47\"><Data ss:Type=\"String\">Date : _________________                Date : _________________                Date : _________________</Data></Cell>");
        wb.println("     </Row>");
        wb.println("     <Row>");
        wb.println("      <Cell ss:Index=\"2\" ss:MergeAcross=\""+(colSpan+3)+"\" ss:StyleID=\"s47\"><Data ss:Type=\"String\">Approve by                                            Review by                                            Prepare by</Data></Cell>");
        wb.println("     </Row>");
        wb.println("     <Row>");
        wb.println("      <Cell ss:Index=\"2\" ss:MergeAcross=\""+(colSpan+3)+"\" ss:StyleID=\"s47\"><Data ss:Type=\"String\"></Data></Cell>");
        wb.println("     </Row>");
        ...
        wb.println("     </Row>");
        wb.println("     <Row>");
        wb.println("      <Cell ss:Index=\"2\" ss:MergeAcross=\""+(colSpan+3)+"\" ss:StyleID=\"s47\"><Data ss:Type=\"String\">______________________                ______________________                ______________________</Data></Cell>");
        wb.println("     </Row>");       
